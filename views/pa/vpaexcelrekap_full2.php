...
<link rel="stylesheet" href="<?php echo base_url();?>css/print.css">
    <h4 style="margin-left: 250px; width: 25cm;" align="center">LAPORAN PEMERIKSAAN PATOLOGI ANATOMI RAWAT JALAN DAN RAWAT INAP <br>
    ...
    <div class="table-responsive">
        ...
        <br>
        <br>
        <div align="right"> dr. Nurbaiti, Sp.PA</div>
    </div>
