 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $("[name='tindakan']").change(function(){
            ...
            var dokter_pa= $("[name='dokter']").val();
            var ukuran_foto= $("[name='ukuran_foto']").val();
            var no_foto= $("[name='no_foto']").val();
            var dokter_pengirim= $("[name='pengirim']").val();
            $.ajax({
                url : "<?php echo base_url();?>pa/addtindakan",
                method : "POST",
                data : {no_reg: no_reg, jenis: jenis, tindakan: tindakan, petugas_pa: petugas_pa,dokter_pa:dokter_pa,ukuranfoto: ukuran_foto,nofoto: no_foto,dokter_pengirim:dokter_pengirim},
        ...
        $('.hapus').click(function(){
            var id= $(this).attr("id");
            $.ajax({
                url : "<?php echo base_url();?>pa/hapusralan",
                method : "POST",
                data : {id: id},
                success: function(data){
                     location.reload();
        ...
        $('.dataChange').click(function(evt) {
            ...
            if (jenis=='petugas_pa'){
                ...
                var result = getpetugaspa(petugas_pa);
                var dataInputField = $(result);
            }
            else
    ...
    var changeData = function(value,id,jenis){
        $.ajax({
            url: "<?php echo site_url('pa/changedata_ralan');?>/"+jenis, 
            type: 'POST', 
...
<div class="col-md-12">
    <div class="box box-primary">
        <?php
            // echo form_open("pa/simpanpa",array("id"=>"formsave","class"=>"form-horizontal"));
        ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="hidden" class="form-control" name='pa' readonly value="<?php echo $row->pa;?>"/>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-control" name="petugas_pa">
                            <?php
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" readonly class="form-control" name='pa' readonly value="<?php echo $row->pa;?>"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo "<td class='text-left'><a href='#' class='petugas_pa dataChange' id='".$data->id."' petugas_pa='".$data->analys."'>".($data->analys=="" ? "---Pilih Petugas PA---" : (isset($petugas_pa[$data->analys]) ? $petugas_pa[$data->analys] : "---Pilih Petugas PA---") )."</a></td>";
