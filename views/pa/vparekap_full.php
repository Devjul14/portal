    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function(){
            ...
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('pa/cetakrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('pa/cetakrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
        ...
        $(".cetak_pasien").click(function(){
            ...
            var url = "<?php echo site_url('pa/cetakpasien_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        ...
        $(".excel").click(function(){
            ...
            var tindakan = $("[name='tindakan']").val();
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('pa/excelrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('pa/excelrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
        ...
        $(".cari").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("pa/rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
       $(".punya").click(function(){
            ...
            var nama_tindakan = $(this).attr("nama_tindakan");
                $.ajax({
                    url: "<?php echo site_url("pa/getpasien_rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2,
