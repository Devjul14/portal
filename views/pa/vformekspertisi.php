...
var mywindow;
    ...
    $(document).ready(function(){
        ...
        $(".ambil").click(function(){
            ...
            var url = "<?php echo site_url('pa/ambildatanormal');?>/"+pa;
            openCenteredWindow(url);
            return false;
        });
        ...
        $("select[name='tindakan']").change(function(){
            ...
            window.location = "<?php echo site_url('pa/ekspertisi');?>/"+no_pasien+"/"+no_reg+"/"+tindakan;
        });
...
<div class="col-md-12">
    <?php
        echo form_open("pa/simpanekspertisi/".$action,array("id"=>"formsave","class"=>"form-horizontal"));
    ?>
    <?php
