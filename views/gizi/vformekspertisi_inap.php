...
var mywindow;
    ...
    $(document).ready(function(){
        ...
        $(".ambil").click(function(){
            var dokter = $("input[name='gizi']").val();
            var url = "<?php echo site_url('gizi/ambildatanormal');?>/"+dokter;
            openCenteredWindow(url);
            return false;
        });
        ...
        $("select[name='tindakan']").change(function(){
            ...
            window.location = "<?php echo site_url('gizi/ekspertisi_inap');?>/"+no_pasien+"/"+no_reg+"/"+tindakan[0]+"/"+tindakan[3]+"/"+tindakan[4];
        });
...
<div class="col-md-12">
    <?php
        echo form_open("gizi/simpanekspertisi_inap/".$action,array("id"=>"formsave","class"=>"form-horizontal"));
    ?>
    <?php
