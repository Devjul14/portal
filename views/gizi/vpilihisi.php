...
<script>
    ...
    $(document).ready(function() {
        ...
        $("tr.isi").dblclick(function(){
            var kode = $(this).attr('kode');
            window.opener.$("input[name='isi']").val(kode);
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="bg-navy">
                            <th width="50">No</th>
                            <th width="200" class="text-center">Status Kamar</th>
                        </tr>        
                    </thead>
                    <tbody>
                        <?php 
                            ...
                            foreach ($q->result() as $data) {
                               $i++;
                               echo "
                                    <tr id=data class='isi' kode='".$data->status_kamar."'>
                                        <td>".$i."</td>
