...
var mywindow;
    ...
    $(document).ready(function() {
        ...
        $(".cetak_pasien").click(function(){
            ...
            var url = "<?php echo site_url('gizi/cetakpasien_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        ...
        $(".cari").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("gizi/rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
       $(".punya").click(function(){
            ...
            var nama_tindakan = $(this).attr("nama_tindakan");
                $.ajax({
                    url: "<?php echo site_url("gizi/getpasien_rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2,
