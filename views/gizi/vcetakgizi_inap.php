                ...
                <tbody>
                    ...
                    <?php
                        ...
                        foreach($a->result() as $data){
                            ...
                            echo "<td>
                                    <textarea class='form-control' style='size:11px;max-width: 100%;height:225px; border-style: none; border: none;' name='hasil_pemeriksaan[".$data->kode."]'>".(isset($hasil_pemeriksaan[$data->kode][$data->pemeriksaan]) ? $hasil_pemeriksaan[$data->kode][$data->pemeriksaan]->hasil_pemeriksaan : "")."</textarea></td>";
                            echo "</tr>";
                        }
...
<?php echo $q->hasil_pemeriksaan ?></textarea></font>
	...
	<table width="100%" align="right">
		<tr>
			<td>&nbsp;</td>
			<td width="25%">&nbsp; <?php echo date("d-m-Y", strtotime($tg->tglp)); ?></td>
		</tr>
		<tr>
				<td></td>
				<td width="25%"> &nbsp;</td>
