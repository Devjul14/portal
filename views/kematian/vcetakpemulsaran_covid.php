...
<script>
    ...
    <br>
    <p>
        <h4 align="center"><b>SURAT KETERANGAN PEMULASARAN / PEMAKAMAN <br><u>PROTOKOL COVID-19</u></b></h4>
    </p>
    <!-- <p align="center">
    ...
    <table width="100%" class="laporan2">
        <tr>
            ...
            <td colspan="2">: Ruang <?php echo $q1->nama_ruangan; ?> RS CIREMAI</td>
        </tr>
        <tr>
            <td><b>Nama</b></td>
    ...
    <br>
    <p>Dan dilakukan pemulsaran / pemakaman secara protokol covid-19.</p>
    <p>
