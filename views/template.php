...
<div class="wrapper">
    <header class="main-header">
        <a href="#" class="logo">
            ...
            <span class="logo-mini"> <img size="20px" height="30px" src="<?php echo base_url();?>assets/foto/Logo.png" alt="User Image"></span>
            <span class="logo-lg">
                <img size="20px" height="30px" src="<?php echo base_url();?>assets/foto/Logo.png" alt="User Image">
            <b>RS Ciremai</b>
            </span>
        </a>
