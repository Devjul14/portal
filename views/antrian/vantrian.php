...
<head>
    ...
    <title id="juduls">PENDAFTARAN RAWAT JALAN</title>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.listdokter').on('click',".lanjut",function(){
            ...
            var id_poli = localStorage.getItem("kode");
            var status = localStorage.getItem('status');
            $.ajax({
                url: "<?php echo site_url('antrian/maks')?>",
                type: 'POST',
                data: {id_dokter:dokter,id_poli:id_poli},
                success: function(result){
                  ...
                  if (result=="true"){
                    ...
                    alert(result);
                    alert("Batas maksimal pasien untuk tanggal yang dipilih sudah maksimal, mohon daftarkan di tanggal lain nya");
                  }
                }
            });
        });
                            ...
                            <div class="box box-solid">
                                <div class="box-body">
                                    <div class="form-group has-feedback">
                                        <input type="text" class="form-control" name="no_rm" placeholder="Nomor RM" autocomplete="off">
