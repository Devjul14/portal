...
<script>
    ...
    <center><strong><h4 style="margin-top:0px; margin-bottom: 0px;">LAPORAN TINDAKAN RAWAT JALAN
    ...
    <table border="1" width="100%" rules="rows" cellspacing="0" cellpadding="1">
        <tr>
            ...
            <td colspan="1"> : <?php echo $q->no_pasien?></td>
        ...
        <tr>
            <th align="left">Dari Poli</th>
            <td colspan="1"> : <?php echo $q->poli?></td>
            <th align="left">Pemeriksaan_penunjang</th>
            <td colspan="5"> : <?php echo $q->pemeriksaan_penunjang ?></td>
        </tr>
