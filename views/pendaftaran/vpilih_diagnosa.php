...
<script>
    ...
    $(document).ready(function() {
        ...
        $("tr.diagnosa").dblclick(function(){
            var kode = $(this).attr('kode');
            var nama = $(this).attr('nama');
            window.opener.$("input[name='kode_diagnosa']").val(kode);
            window.opener.$("input[name='diagnosa_masuk']").val(nama);
            close();
            return false;
        });
    });
                    ...
                    <tbody>
                        <?php 
                            ...
                            foreach ($q->result() as $data) {
                               $i++;
                               echo "
                                    <tr id=data class='diagnosa' kode='".$data->kode."' nama='".$data->nama."'>
                                        <td>".$data->kode."</td>
                                        <td>".$data->nama."</td>
                                    </tr>
                                ";
