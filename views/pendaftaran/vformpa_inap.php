        ...
        <div class="box-body">
        	...
        	<div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" name="dokter_pa">
                            <?php
                                foreach ($d->result() as $dk) {
                                    echo "
                                        <option value='".$dk->id_dokter."' ".($dk->id_dokter==$row->dokter_poli ? "selected" : "")." data-id='".$dk->pa."'>".$dk->nama_dokter."</option>
                                    ";
                                }
                            ?>
                        </select>
                        ...
                        <select class="form-control" name="petugas_pa">
                            <?php
                                foreach ($r->result() as $rg) {
                                    echo "
                                        <option value='".$rg->nip."' ".($rg->nip==$row->petugas_pa ? "selected" : "").">".$rg->nama."</option>
                                    ";
                                }
                            ?>
                        </select>
