...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('dokter/reset_ralan');?>/";
            // location.reload();
            return false;
        });
        ...
        $(".igd").click(function(){
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('pendaftaran/igd_inap')?>/"+no_rm+"/"+no_reg;
            return false;
        });
        $(".send").click(function(){
            var no_rm = $(".bg-gray").attr("href");
                ...
                <div class="col-xs-12">
                    ...
                    <div class="pull-right">
                       ...
                       <!--  <button class="laporan_operasi btn btn-sm btn-primary" type="button">Laporan Ops Mata</button> --><!-- 
                        ...
                        <!-- <button class="igd btn btn-sm bg-navy" type="button">Assesment IGD</button> -->
                    </div>
                </div>
            </div>
        </div>
