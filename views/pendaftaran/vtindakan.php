                ...
                <tbody>
                    <?php
                        ...
                        foreach($k1->result() as $data1){
                            ...
                            echo "<td class='text-right'>".number_format($data1->jumlah,0,'.','.')."</td>";
                            echo "</tr>";
                        }
                        foreach($k2->result() as $data2){
                            ...
                            echo "<td class='text-right'>".number_format($data2->jumlah,0,'.','.')."</td>";
                            echo "</tr>";
                        }
                ...
                <tfoot>
                    <!-- <tr>
                        ...
                        <th style="vertical-align: middle" > -->
                            <input type="hidden" readonly name="subtotal" class="form-control text-right" value="<?php echo number_format($subtotal,0,',','.');?>">
                        <!-- </th>
                    </tr> -->
                    <!-- <tr>
                        ...
                        <th width="250px" style="vertical-align: middle" >
                            <div class="row">
                                <div class="col-sm-5"> -->
                                    <input type="hidden" readonly name="dp_persen" class="form-control text-right" value="<?php echo $dp_persen;?>">
                                <!-- </div> -->
                                <!-- <div class="col-sm-7">   -->
                                    <input type="hidden" readonly name="dp_nominal" class="form-control text-right" value="<?php echo number_format($dp_nominal,0,',','.');?>">
                                <!-- </div> -->
                            <!-- </div> -->
                        <!-- </th> -->
                    <!-- </tr> -->
                    <!-- <tr>
                        ...
                        <th width="250px" style="vertical-align: middle" >
                            <div class="row">
                                <div class="col-sm-5"> -->
                                    <input type="hidden" readonly name="disc_persen" class="form-control text-right" value="<?php echo $disc_persen;?>">
                                <!-- </div> -->
                                <!-- <div class="col-sm-7">   -->
                                    <input type="hidden" readonly name="disc_nominal" class="form-control text-right" value="<?php echo number_format($disc_nominal,0,',','.');?>">
                                <!-- </div> -->
                            <!-- </div> -->
                        <!-- </th> -->
                    <!-- </tr> -->
                    ...
                    <!-- <tr>
                        ...
                        <th style="vertical-align: middle" > -->
                            <input type="hidden" name="sharing" class="form-control text-right" value="<?php echo number_format($sharing,0,',','.');?>">
                        <!-- </th>
                    </tr> -->
                    <?php endif ?>
                    <tr>
                        ...
                        <th style="vertical-align: middle" ><input type="text" readonly name="total" class="form-control text-right" value="<?php echo number_format($total,0,',','.');?>"></th></tr>
                </tfoot>
            </table>
        </div>
