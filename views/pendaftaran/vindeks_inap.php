 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $('.hapus').click(function(){
            var id = $(this).attr("id");
            $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/hapus_indeksicd10_inap",
                    method : "POST",
                    data : {id: id},
        ...
        $('.hapus2').click(function(){
            var id = $(this).attr("id");
            $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/hapus_indeksicd9_inap",
                    method : "POST",
                    data : {id: id},
                    success: function(data){
                         location.reload();
        ...
        $('.urut').change(function(){
            ...
            $.ajax({
                    url : "<?php echo base_url();?>grouper/edit_indeks_urut_inap",
                    method : "POST",
        ...
        $("[name='icd10']").typeahead({
            ...
            updater: function(item) {
                ...
                var kode = n[0];
                $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/simpan_indeksicd10_inap",
                    method : "POST",
        ...
        $("[name='edit_icd10']").typeahead({
            ...
            updater: function(item) {
                ...
                var kode = n[0];
                $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/edit_indeksicd10_inap",
                    method : "POST",
        ...
        $("[name='icd9']").typeahead({
            ...
            updater: function(item) {
                ...
                var kode = n[0];
                $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/simpan_indeksicd9_inap",
                    method : "POST",
                    data : {no_reg: no_reg, kode: kode},
                    success: function(data){
                         location.reload();
        ...
        $("[name='edit_icd9']").typeahead({
            ...
            updater: function(item) {
                ...
                var kode = n[0];
                $.ajax({
                    url : "<?php echo base_url();?>pendaftaran/edit_indeksicd9_inap",
                    method : "POST",
                    data : {no_reg: no_reg, kode: kode, id: id},
                    success: function(data){
                         location.reload();
        ...
        <div class="box-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input readonly type="text" class="form-control" name='tanggal' value="<?php echo $row->tgl_masuk;?>"/>
                    </div>
                ...
                <div>
                    ...
                    <div class="col-md-3">
                        <input readonly type="text" class="form-control" name='tgl_lahir' value="<?php echo ($row->tgl_keluar=="" ? "" : date("d-m-Y H:i:s",strtotime($row->tgl_keluar)));?>" autocomplete="off"/>
                    </div>    
                </div>
            </div>
        </div>
