...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo form_open_multipart("pendaftaran/uploadpdf_ralan",array("id"=>"formsave","class"=>"form-horizontal")) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="file" name="pdf_ralan" accept="application/pdf,application/jpg">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach($q1->result() as $val){
                                ...
                                echo "<td>".$i."</td>";
                                echo "<td><a href='".base_url()."file_pdf/ralan/".$val->file_pdf."' target='blank'>".$val->file_pdf."</a></td>";
                                echo "</tr>";
                            }
