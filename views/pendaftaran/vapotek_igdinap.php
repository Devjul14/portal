...
<div class="col-md-12">
    <div class="box box-primary">
        ...
        <div class="box-footer">
            <div class="row">
                <?php echo form_open("dokter/addobat_inap",array("id"=>"formsave_obat","class"=>"form-horizontal"));?>
                ...
                <input type="hidden" name='iddokter' readonly value="<?php echo $id_dokter;?>"/>
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th width=300px rowspan="2" class="text-center">Jumlah</th>
                        <th rowspan="2"></th>
                    </tr>
                    <tr class="bg-navy">
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo form_open("dokter/simpanwaktu_inap",array("id"=>"formsave","class"=>"form-horizontal"));
                                ...
                                echo "<input type = 'hidden' name='iddokter' value='".$id_dokter."'>";
                                ...
                                echo "<td class='text-right'><input class='form-control' type = 'text 'name='siang' value='".$data->siang."'></td>";
                ...
                <tfoot>
                    <tr>
                        ...
                        <th colspan="4" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th>
                    ...
                    <tr><th colspan="12" style="vertical-align: middle" ><?php echo $tgl_pembayaran;?><span class="pull-right">Total</span></th><th colspan="2" style="vertical-align: middle" ><input type="text" readonly name="total" class="form-control text-right" value="<?php echo number_format($total,0,',','.');?>"></th></tr>
                </tfoot>
            </table>
            </div>
        </div>
