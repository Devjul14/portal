            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th colspan="3" class="text-center">Cara</th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo "<td class='text-right'>".$data->nama_aturan."</td>";
                            echo "<td class='text-right'>".$data->nama_waktu."</td>";
                            echo "<td class='text-right'>".$data->pagi."</td>";
                            echo "<td class='text-right'>".$data->sore."</td>";
                            echo "<td class='text-right'>".$data->malem."</td>";
