    ...
    <table class="laporan" width="100%">
        <tr>
            ...
            <td rowspan="6" align="center" style="vertical-align:middle">
                <h4 style="margin-top:0px; margin-bottom: 0px;">LEMBAR HASIL TINDAKAN UJI FUNGSI PROSEDUR KEDOKTERAN FISIK DAN REHABILITASI</h4>
            </td>
        ...
        <tr>
            <td colspan="4"><b>Lembar Hasil Tindakan Uji Fungsi/ Prosedur KFR : <?php echo $q->tindakan;?> (Koding : <?php echo $icd9[$q->koding];?>)</b></td>
        </tr>
        <tr>
            <td>Diagnosa Fungsional</td>
            <td colspan="3"><?php echo $q->kode_diagnosis_fungsional." - ".$icd[$q->kode_diagnosis_fungsional];?></td>
        </tr>
        <tr>
            <td>Diagnosa Medis</td>
            <td colspan="3"><?php echo $q->kode_diagnosis_medis." - ".$icd[$q->kode_diagnosis_medis];?></td>
        </tr>
        <tr>
            <td>Hasil yang didapat</td>
            <td colspan="3"><?php echo $q->hasil;?></td>
        </tr>
        <tr>
            <td>Kesimpulan</td>
            <td colspan="3"><?php echo $q->kesimpulan;?></td>
        </tr>
        <tr>
            <td>Rekomendasi</td>
            <td colspan="3"><?php echo $q->rekomendasi;?></td>
        </tr>
        <tr>
