        ...
        <div class="box-body">
        	<div class="col-md-6">
        		<div class="form-horizontal">
    	            <?php
    	                echo form_open("pendaftaran/simpanpindahstatus_ralan/",array("id"=>"formsave","class"=>"form-horizontal"));
    	            ?>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Gol. Pasien Lama</label>
                        <div class="col-md-9">
                            <input type="hidden" class="form-control"  name="id_gol_lama" readonly value="<?php echo $row->gol_pasien;?>">
                            <input type="text" class="form-control"  name="nama_gol" readonly value="<?php echo $row->keterangan;?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Perusahaan</label>
                        <div class="col-md-9">
                            <input type="hidden" class="form-control"  name="id_perusahaan_lama" readonly value="<?php echo $row->perusahaan;?>">
                            <input type="text" class="form-control"  name="nama_perusahaan" readonly value="<?php echo $row->nama_perusahaan;?>">
                        </div>
                    </div>
                </div>
        	</div>
        	<div class="col-md-6">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Gol. Pasien Baru</label>
                        <div class="col-md-9">
                            <select class="form-control" name="id_gol_baru">
                                <?php
                                    foreach ($g->result() as $val) {
                                        echo "
                                            <option value='".$val->id_gol."'>".$val->keterangan."</option>
                                        ";
                                    }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Perusahaan</label>
                        <div class="col-md-9">
                            <select class="form-control" name="id_perusahaan_baru">
                                <option value="-">-----</option>
                                <?php
                                    foreach ($p->result() as $per) {
                                        echo "
                                            <option value='".$per->kode."'>".$per->nama."</option>
                                        ";
                                    }
                                ?>
                            </select>
