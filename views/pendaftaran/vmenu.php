<?php if ($this->session->userdata("idstatus") == 21) : ?>
    ...
    <li class="treeview <?php echo ($menu == 'laporan' ? 'active' : ''); ?>">
        ...
        <ul class="treeview-menu">
            ...
            echo "<li>" . anchor("laporan/inos_bulanan", "Inos Bulanan");
            echo "<li>" . anchor("laporan/sensusharian", "Sensus Harian");
...
<?php elseif ($this->session->userdata("idstatus") == 22) : ?>
    <li class="treeview <?php echo ($menu == 'home' ? 'active' : ''); ?>">
        ...
        <ul class="treeview-menu">
            ...
            <?php echo "<li>" . anchor("oka/rekap_full/all", "Oka") . "</li>"; ?>
            <?php echo "<li>" . anchor("home/pasienrujuk", "Pasien Rujuk") . "</li>"; ?>
            <?php echo "<li>" . anchor("laporan/sensusharian", "Sensus Harian") . "</li>"; ?>
        </ul>
    </li>
    <li class="<?php echo ($menu == 'ralan' ? 'active' : ''); ?>">
        <?php echo anchor("pendaftaran/rawat_jalan", "<i class='fa fa-ambulance'></i><span class='nav-label'>Rawat Jalan</span>"); ?>
...
<?php else : ?>
    <li class="treeview <?php echo ($menu == 'home' ? 'active' : ''); ?>">
        ...
        <ul class="treeview-menu">
            ...
            <?php echo "<li>" . anchor("gizi/rekap_full/all", "Gizi") . "</li>"; ?>
            <?php echo "<li>" . anchor("home/rekap_full/all", "Poliklinik") . "</li>"; ?>
            <!-- <?php echo "<li>" . anchor("home/rekap_full_new/all", "Poliklinik New") . "</li>"; ?> -->
            <?php echo "<li>" . anchor("home/igd", "IGD") . "</li>"; ?>
            <?php echo "<li>" . anchor("oka/rekap_full/all", "Oka") . "</li>"; ?>
            <?php echo "<li>" . anchor("home/pasienrujuk", "Pasien Rujuk") . "</li>"; ?>
            <?php echo "<li>" . anchor("laporan/sensusharian", "Sensus Harian");?>
    ...
    <li class="treeview <?php echo ($menu == 'perawat' ? 'active' : ''); ?>">
        ...
        <ul class="treeview-menu">
            ...
            <?php echo "<li>" . anchor("home/kontrole", "Kontrole") . "</li>"; ?>
        </ul>
    </li>
