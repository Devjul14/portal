...
<div class="col-md-12">
    <div class="box box-primary">
        <?php
            echo form_open("pendaftaran/simpankonsulinap",array("id"=>"formsave","class"=>"form-horizontal"));
        ?>
        <div class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Konsul</label>
                    <div class="col-md-10">
                        <textarea name="konsul" cols="175" class="form-control" rows="12"></textarea>
                    </div>
                </div>
            </div>
