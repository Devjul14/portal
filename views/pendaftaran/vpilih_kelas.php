...
<script>
    ...
    $(document).ready(function() {
        ...
        $("tr.kelas").dblclick(function(){
            var kode = $(this).attr('kode');
            var keterangan = $(this).attr('keterangan');
            window.opener.$("input[name='kode_kelas']").val(kode);
            window.opener.$("input[name='kelas']").val(keterangan);
                    ...
                    <tbody>
                        <?php 
                            ...
                            foreach ($q->result() as $data) {
                               $i++;
                               echo "
                                    <tr id=data class='kelas' kode='".$data->kode_kelas."' keterangan='".$data->nama_kelas."'>
                                        <td>".$i."</td>
