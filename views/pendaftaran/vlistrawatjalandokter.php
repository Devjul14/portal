...
<script>
    ...
    $(document).ready(function(e){
        ...
        $(".cppt").click(function(){
            ...
            window.location = "<?php echo site_url('dokter/cppt_ralan')?>/"+id;
            return false;
        });
        $('.pdf').click(function(){
        ...
        $(".pengantar_terapi").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('dokter/pengantar_terapi')?>/"+id;
            return false;
        });
        ...
        $(".mcu").click(function(){
            ...
            window.location ="<?php echo site_url('pendaftaran/mcu');?>/"+no_rm+"/"+poli;
            return false;
        });
...
<div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
              ...
              <div class="pull-right">
                ...
                <button class="mcu btn btn-sm btn-primary" type="button"> MCU</button>
                <div class="dropup">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="pull-right">
                <button class="pengantar_terapi btn btn-sm bg-purple" type="button">Pengantar Terapi/ Tindakan</button>
