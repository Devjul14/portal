    ...
    $(document).ready(function(){
        ...
        $("[name='tindakan']").change(function(){
            ...
            $.ajax({
                ...
                method : "POST",
                data : {no_reg: no_reg, kode_kelas: kode_kelas, tindakan: tindakan,tanggal: tanggal, pemeriksaan: pemeriksaan,dokter_radiologi:dokter_radiologi,radiografer:radiografer,dokter_pengirim:dokter_pengirim},
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th class="text-center">Uk Foto 1</th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo "<td class='text-right'><a href='#' class='dataChange ukuranfoto1' id='".$data->id."'>".($data->ukuranfoto1=="" ? "-" : $data->ukuranfoto1)."</a></td>";
                ...
                <tfoot>
                    <tr><th colspan="10" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th><th style="vertical-align: middle" ><input type="text" readonly name="subtotal" class="form-control text-right" value="<?php echo number_format($subtotal,0,',','.');?>"></th></tr>
                    <tr>
                    ...
                    <tr><th colspan="10" style="vertical-align: middle" ><span class="pull-right">Sharing</span></th><th style="vertical-align: middle" ><input type="text" name="sharing" class="form-control text-right" value="<?php echo number_format($sharing,0,',','.');?>"></th></tr>
