        ...
        <div class="box-body">
        	<div class="col-md-6">
        		<div class="form-horizontal">
    	            <?php
    	                echo form_open("pendaftaran/simpanpindahstatus/",array("id"=>"formsave","class"=>"form-horizontal"));
    	            ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="hidden" class="form-control"  name="id_gol_lama" readonly value="<?php echo $row->id_gol;?>">
