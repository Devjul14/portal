            ...
            <table class="table table-bordered table-hover " id="myTable">
                ...
                <tbody>
                    ...
                    foreach ($q3->result() as $row) {
                        ...
                        $cek = "<span class='gk_".$row->no_pasien."_".$row->no_reg."'><i class='fa fa-refresh fa-spin'></i></span>";
                        echo "<tr id=data href='" . $row->no_pasien . "/" . $row->no_reg . "' gk='".$row->no_pasien . "_" . $row->no_reg."' telpon='" . $telpon . "' no_antrian='" . $row->no_antrian . "' no_sep='" . $row->no_sjp . "' no_pasien='" . $row->no_pasien . "' no_reg='" . $row->no_reg . "' no_bpjs='" . $row->no_bpjs . "' poli='" . $row->tujuan_poli . "' dokter='" . $row->dokter_poli . "' jenis_kelamin='" . ($row->jenis_kelamin=="L" ? "Laki-laki" : "Perempuan") . "' ket_pulang='" . $row->ket_pulang . "' status_pulang='" . $row->status_pulang . "'>";
                        echo "<td class='text-center'>" . $cek . " " . $row->no_antrian . ($row->panggil == 1 ? "<span class='pull-right'><i class='fa fa-bullhorn text-red'></i></span>" : "") . "</td>";
                        echo "<td class='text-center'>" . $row->no_pasien . "</td>";
                        echo "<td class='text-center'>" . $row->no_reg . "</td>";
                        echo "<td>" . $row->nama_pasien . "</td>";
                        echo "<td>" . (isset($poli[$row->dari_poli]) ? $poli[$row->dari_poli] : "") . "</td>";
                        echo "<td>" . (isset($poli[$row->tujuan_poli]) ? $poli[$row->tujuan_poli] : "") . "</td>";
