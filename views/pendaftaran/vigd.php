...
var mywindow;
    ...
    $(document).ready(function(){
        $("input[name='gcs']").on('input', function () {
            ...
            if (gcs=="Stupor") { min=4; max=6 } else 
        ...
        $('.terapi').click(function(){
            var no_reg= $("[name='no_reg']").val();
            var no_rm= $("[name='no_rm']").val();
            window.location ="<?php echo site_url('dokter/apotek_igd');?>/"+no_rm+"/"+no_reg;
            return false;
        });
        $('.anatomi').click(function(){
            var no_rm= $("[name='no_rm']").val();
            var no_reg= $("[name='no_reg']").val();
            window.location ="<?php echo site_url('assesmen/getanatomi');?>/"+no_reg;
            return false;
        });
...
<div class="col-md-12">
    <?php
        echo form_open("dokter/simpanigd/".$no_reg,array("id"=>"formsave","class"=>"form-horizontal"));
    ?>
    <?php
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="kesadaran" id="" class="form-control">
                        ...
                        <option value="Stupor"  <?php echo ($kesadaran=="Stupor" ? "selected" : "");?>>Stupor</option>
