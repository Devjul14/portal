...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".simpanttd").click(function(){
            ...
            $.ajax({
                type  : "POST",
                data  : {no_pasien:no_pasien,ttd: ttd},
                url   : "<?php echo site_url('pendaftaran/simpanttd');?>",
                success : function(result){
                    location.reload();
                },
                error: function(result){
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        echo "<tr id=data href='".$row->no_pasien."' nama='".$row->nama_pasien."' status_pinjam='".$row->status_pinjam."'>";
        ...
        <div class="box-footer">
            <div class="pull-left">
                <div class="btn-group">
                    ...
                    <button class="retensi btn btn-danger" type="button"><i class="fa fa-remove"></i> Retensi</button>
                    <button class="cetak btn btn-success" type="button"><i class="fa fa-save"></i> Cetak</button>
                    <button class="ttd btn btn-success" type="button"><i class="fa fa-gg"></i> Tanda Tangan</button>
                </div>
                <div class="btn-group">
                ...
                <div class="btn-group">
                    <button class="inap btn btn-info" type="button"> R. Inap</button>
                ...
                <div class="btn-group">
                    ...
                    <!-- <button class="kembali btn btn-success" type="button"> Kembali</button> -->
                </div>
            </div>
...
<div class="modal modalttd">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <i class="icon fa fa-warning"></i>&nbsp;&nbsp;Tanda Tangan
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class='modal-body'>
            ...
            <div class='modal-footer'>
                <button class="clear btn btn-sm btn-success">Clear</button>
                <button class="simpanttd btn btn-sm btn-danger">Simpan</button>
            </div>
        </div>
    </div>
</div>
