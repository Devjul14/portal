...
<script>
    ...
    $(document).ready(function() {
        ...
        $("tr.poliklinik").dblclick(function(){
            ...
            window.opener.$("input[name='kode_poli']").val(kode);
            window.opener.$("input[name='poli']").val(keterangan);
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="bg-navy">
                            <th width="50">No</th>
                            <th width="200" class="text-center">Poliklinik</th>
                            <th class="text-center">Briging</th>
                        </tr>        
                    </thead>
                    <tbody>
                        <?php 
