		...
		<td><table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr>
                        ...
                        <th >Nama</th>
                        <th class='text-center'>Tanggal/ Jam Terima Pasien</th>
                        <th class='text-center'>Tanggal/ Jam Layani Pasien</th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach($q->result() as $data){
							$tp  = date_create($data->tgl_terimapasien);
							$tl  = date_create($data->tgl_layani);
							$diff  = date_diff($tp, $tl);

                            echo "<tr>";
                            echo "<td>".$i++."</td>";
                            echo "<td class='no_reg text-center'>".$data->no_reg."";
                            echo "<td>".$data->nama_pasien."</td>";
                            echo "<td>".$data->tgl_terimapasien."</td>";
