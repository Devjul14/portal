...
<script>
    ...
    $(document).ready(function(e) {
        ...
        $(".permintaan").click(function() {
            var id = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            var url = "<?php echo site_url('pendaftaran/detaillab_inap'); ?>/" + id + "/" + no_reg;
            window.location = url;
            return false;
        });
        ...
        $(".permintaanradiologi").click(function() {
            var id = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            var url = "<?php echo site_url('pendaftaran/detailradiologi_inap'); ?>/" + id + "/" + no_reg;
            window.location = url;
            return false;
        });
        ...
        $(".permintaangizi").click(function() {
            var id = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            var url = "<?php echo site_url('pendaftaran/detailgizi_inap'); ?>/" + id + "/" + no_reg;
            window.location = url;
            return false;
        });
        ...
        $(".permintaanpa").click(function() {
            var id = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            var url = "<?php echo site_url('pendaftaran/detailpa_inap'); ?>/" + id + "/" + no_reg;
            window.location = url;
            return false;
        });
        ...
        $(".reset").click(function() {
            window.location = "<?php echo site_url('dokter/reset_ranapdokter'); ?>/";
            return false;
        });
        ...
        $(".triage").click(function() {
            window.location = "<?php echo site_url('pendaftaran/triage_inap') ?>";
            return false;
        });
        $(".edit").click(function() {
            var no_rm = $(".bg-gray").attr("href");
        ...
        $(".igd").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/igdinap') ?>/" + no_rm + "/" + no_reg;
            return false;
        });
        $(".send").click(function() {
            var no_rm = $(".bg-gray").attr("href");
        ...
        $(".visit").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/visit_inap') ?>/" + no_rm + "/" + no_reg;
            return false;
        });
        $(".konsul").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/konsul_inap') ?>/" + no_rm + "/" + no_reg;
            return false;
        });
        $(".resume").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/resume_inap') ?>/" + no_rm + "/" + no_reg;
            return false;
        });
        $(".rujukan").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/rujukan_pasien') ?>/" + no_rm + "/" + no_reg + "/ranap";
            return false;
        });
        $(".sebabkematian").click(function() {
            ...
            if (status_pulang==4){
              window.location = "<?php echo site_url('dokter/sebabkematian') ?>/" + no_rm + "/" + no_reg + "/ranap";
            } else {
        ...
        $(".jawaban_konsul").click(function() {
            var no_rm = $(".bg-gray").attr("href");
            var no_reg = $(".bg-gray").attr("no_reg");
            window.location = "<?php echo site_url('dokter/jawabankonsul_inap') ?>/" + no_rm + "/" + no_reg;
            return false;
        });
        $(".cppt").click(function() {
            var no_rm = $(".bg-gray").attr("href");
        ...
        $(".migrasi").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('dokter/cekpasien_inap'); ?>",
                success: function(result) {
                    var value = JSON.parse(result);
                    if (value.tgl_keluar=="" || value.tgl_keluar==null){
                      alert("Pasien belum dipulangkan");
                    } else {
        ...
        $(".lanjut").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('dokter/migrasi_inap'); ?>",
                success: function(result) {
                    location.reload();
                },
                error: function(result) {
            ...
            <table class="table table-bordered table-hover " id="myTable">
                ...
                <tbody>
                    ...
                    foreach ($q3->result() as $row) {
                        echo "<tr id=data href='" . $row->no_rm . "' no_reg='" . $row->no_reg . "' no_bpjs='" . $row->no_bpjs . "' kode_kamar='" . $row->kode_kamar . "' kode_kelas='" . $row->kode_kelas . "' kode_ruangan='" . $row->kode_ruangan . "' no_bed='" . $row->no_bed . "' no_sep='" . $row->no_sjp . "' tgl_masuk='" . date("Y/m/d", strtotime($row->tgl_masuk)) . "' status_pulang='".$row->status_pulang."'>";
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="pull-left">
                        ...
                        <button class="resume btn btn-sm bg-maroon" type="button"> Resume</button>
                    ...
                    <div class="pull-right">
                        ...
                        <button class="laporan_operasi btn btn-sm btn-warning" type="button">Laporan Operasi</button>
                        <button class="laporan_operasi btn btn-sm btn-primary" type="button">Laporan Ops Mata</button>
                        <!--
                        <button class="rtpelayanan btn btn-sm btn-success" type="button">Respon Time Pelayanan</button> -->
                        <button class="visit btn btn-sm bg-green" type="button">Visit</button>
                        <button class="konsul btn btn-sm bg-maroon" type="button">Konsul</button>
                        <button class="jawaban_konsul btn btn-sm btn-warning" type="button">Jawaban Konsul</button>
                        <button class="cppt btn btn-sm bg-orange" type="button">CPPT</button>
                        <button class="igd btn btn-sm bg-navy" type="button">Assesment</button>
                        <!-- <button class="edit btn btn-sm btn-success" type="button">Edit</button>
                        <button class="triage btn btn-sm bg-aqua" type="button">Tambah</button> -->
                    </div>
                </div>
            </div>
        </div>
...
<div class='modal modal_cekpasien no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Yakin akan migrasi pasien ke rawat jalan ?</h4>
            </div>
            <div class='modal-body'>
                <div class="form-horizontal">
                    <div class="form-group">
