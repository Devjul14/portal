...
header("Content-Disposition: attachment; filename=SENSUS HARIAN.xls");
$bln = array(
...
<body class="page">
    ...
    <p align="center">SENSUS HARIAN</br>
      <?php
      if ($bagian=="covid")
    ...
    <table class="laporan" border="1" width="100%">
        ...
        <thead>
            <tr class="bg-navy">
                ...
                <th style="vertical-align:middle" width="150" align='center' rowspan="4">Ruang</th>
                <th style="vertical-align:middle" align='center' colspan="13" rowspan="2">Pasien Lama</th>
                <th style="vertical-align:middle" align='center' colspan="13" rowspan="2">Pasien Baru</th>
                <th style="vertical-align:middle" align='center' colspan="78">Pasien Pulang</th>
                <th style="vertical-align:middle" width="50" class="text-center" rowspan="4">Jumlah</th>
            </tr>
            <tr class="bg-navy">
              <th style="vertical-align:middle" align='center' colspan="13">Persetujuan Dokter</th>
              <th style="vertical-align:middle" align='center' colspan="13">Permintaan Sendiri</th>
              <th style="vertical-align:middle" align='center' colspan="13">Rujukan RS Lain</th>
              <th style="vertical-align:middle" align='center' colspan="13">Meninggal < 48 jam</th>
              <th style="vertical-align:middle" align='center' colspan="13">Meninggal > 48 jam</th>
              <th style="vertical-align:middle" align='center' colspan="13">Lain-lain</th>
            </tr>
            <tr class="bg-navy">
              <th style="vertical-align:middle" align='center' colspan="3">AL</th>
              <th style="vertical-align:middle" align='center' colspan="3">AD</th>
              <th style="vertical-align:middle" align='center' colspan="3">AU</th>
            ...
            <tr class="bg-navy">
              <th style="vertical-align:middle" align='center'>T</th>
              <th style="vertical-align:middle" align='center'>S</th>
              <th style="vertical-align:middle" align='center'>K</th>
              <th style="vertical-align:middle" align='center'>T</th>
              <th style="vertical-align:middle" align='center'>S</th>
              <th style="vertical-align:middle" align='center'>K</th>
              <th style="vertical-align:middle" align='center'>T</th>
        ...
        <tbody>
          ...
          for ($d= 1; $d <= $jml ; $d++) {
            ...
            if ($bagian=="covid")
              echo "<td align='center'>COVID</td>";
            elseif ($bagian=="08")
              echo "<td align='center'>Kelas 3</td>";
            elseif ($bagian=="07")
              echo "<td align='center'>Kelas 2</td>";
            elseif ($bagian=="06")
              echo "<td align='center'>Kelas 1</td>";
            elseif ($bagian=="vip")
            ...
            echo "<td align='center'>" . ($lama[406]=="" ? 0 : $lama[406]) . "</td>";
            echo "<td align='center'>" . ($lama[410]=="" ? 0 : $lama[410]). "</td>";
            echo "<td align='center'>" . (($lama[416]=="" ? 0 : $lama[416]) + ($lama[422]=="" ? 0 : $lama[422])). "</td>";
            echo "<td align='center'>" . ($lama[404]=="" ? 0 : $lama[404]) . "</td>";
            echo "<td align='center'>" . ($lama[408]=="" ? 0 : $lama[408]). "</td>";
            echo "<td align='center'>" . (($lama[415]=="" ? 0 : $lama[415]) + ($lama[421]=="" ? 0 : $lama[421])) . "</td>";
            echo "<td align='center'>" . ($lama[405]=="" ? 0 : $lama[405]) . "</td>";
            echo "<td align='center'>" . ($lama[409]=="" ? 0 : $lama[409]). "</td>";
            echo "<td align='center'>" . (($lama[417]=="" ? 0 : $lama[417]) + ($lama[423]=="" ? 0 : $lama[423])) . "</td>";
            echo "<td align='center'>" . (($lama[412]=="" ? 0 : $lama[412]) + ($lama[413]=="" ? 0 : $lama[413])) . "</td>";
            echo "<td align='center'>" . ($lama["UMUM"]=="" ? 0 : $lama["UMUM"]) . "</td>";
            echo "<td align='center'>" . ($lama["PERUSAHAAN"]=="" ? 0 : $lama["PERUSAHAAN"]) . "</td>";
            echo "<td align='center'>" . ($lama["BPJS"]=="" ? 0 : $lama["BPJS"]) . "</td>";
            echo "<td align='center'>" . $baru[406] . "</td>";
            echo "<td align='center'>" . $baru[410] . "</td>";
            echo "<td align='center'>" . ($baru[416]+$baru[422]) . "</td>";
            echo "<td align='center'>" . $baru[404] . "</td>";
            echo "<td align='center'>" . $baru[408] . "</td>";
            echo "<td align='center'>" . ($baru[415]+$baru[421]) . "</td>";
            echo "<td align='center'>" . $baru[405] . "</td>";
            echo "<td align='center'>" . $baru[409] . "</td>";
            echo "<td align='center'>" . ($baru[417]+$baru[423]) . "</td>";
            echo "<td align='center'>" . ($baru[412]+$baru[413]) . "</td>";
            echo "<td align='center'>" . $baru["UMUM"] . "</td>";
            echo "<td align='center'>" . $baru["PERUSAHAAN"] . "</td>";
            echo "<td align='center'>" . $baru["BPJS"] . "</td>";
            ...
            for ($n=1;$n<=5;$n++) {
              if ($n==4){
                echo "<td align='center'>" . ($meninggal[4][406]=="" ? 0 : $meninggal[4][406]) . "</td>";
                echo "<td align='center'>" . ($meninggal[4][410]=="" ? 0 : $meninggal[4][410]). "</td>";
                echo "<td align='center'>" . (($meninggal[4][416]=="" ? 0 : $meninggal[4][416]) + ($meninggal[4][422]=="" ? 0 : $meninggal[4][422])) . "</td>";
                echo "<td align='center'>" . ($meninggal[4][404]=="" ? 0 : $meninggal[4][404]) . "</td>";
                echo "<td align='center'>" . ($meninggal[4][408]=="" ? 0 : $meninggal[4][408]) . "</td>";
                echo "<td align='center'>" . (($meninggal[4][415]=="" ? 0 : $meninggal[4][415]) + ($meninggal[4][421]=="" ? 0 : $meninggal[4][421])) . "</td>";
                echo "<td align='center'>" . ($meninggal[4][405]=="" ? 0 : $meninggal[4][405]) . "</td>";
                echo "<td align='center'>" . ($meninggal[4][409]=="" ? 0 : $meninggal[4][409]) . "</td>";
                echo "<td align='center'>" . (($meninggal[4][417]=="" ? 0 : $meninggal[4][417]) + ($meninggal[4][423]=="" ? 0 : $meninggal[4][423])) . "</td>";
                echo "<td align='center'>" . (($meninggal[4][412]=="" ? 0 : $meninggal[4][412]) + ($meninggal[4][413]=="" ? 0 : $meninggal[4][413]))  . "</td>";
                echo "<td align='center'>" . ($meninggal[4]["UMUM"]=="" ? 0 : $meninggal[4]["UMUM"]) . "</td>";
                echo "<td align='center'>" . ($meninggal[4]["PERUSAHAAN"]=="" ? 0 : $meninggal[4]["PERUSAHAAN"]) . "</td>";
                echo "<td align='center'>" . ($meninggal[4]["BPJS"]=="" ? 0 : $meninggal[4]["BPJS"]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][406]=="" ? 0 : $meninggal[5][406]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][410]=="" ? 0 : $meninggal[5][410]). "</td>";
                echo "<td align='center'>" . (($meninggal[5][416]=="" ? 0 : $meninggal[5][416]) + ($meninggal[5][422]=="" ? 0 : $meninggal[5][422])) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][404]=="" ? 0 : $meninggal[5][404]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][408]=="" ? 0 : $meninggal[5][408]) . "</td>";
                echo "<td align='center'>" . (($meninggal[5][415]=="" ? 0 : $meninggal[5][415]) + ($meninggal[5][421]=="" ? 0 : $meninggal[5][421])) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][405]=="" ? 0 : $meninggal[5][405]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5][409]=="" ? 0 : $meninggal[5][409]) . "</td>";
                echo "<td align='center'>" . (($meninggal[5][417]=="" ? 0 : $meninggal[5][417]) + ($meninggal[5][423]=="" ? 0 : $meninggal[5][423])) . "</td>";
                echo "<td align='center'>" . (($meninggal[5][412]=="" ? 0 : $meninggal[5][412]) + ($meninggal[5][413]=="" ? 0 : $meninggal[5][413]))  . "</td>";
                echo "<td align='center'>" . ($meninggal[5]["UMUM"]=="" ? 0 : $meninggal[5]["UMUM"]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5]["PERUSAHAAN"]=="" ? 0 : $meninggal[5]["PERUSAHAAN"]) . "</td>";
                echo "<td align='center'>" . ($meninggal[5]["BPJS"]=="" ? 0 : $meninggal[5]["BPJS"]) . "</td>";
              } else {
                echo "<td align='center'>" . ($pulang[$n][406]=="" ? 0 : $pulang[$n][406]) . "</td>";
                echo "<td align='center'>" . ($pulang[$n][410]=="" ? 0 : $pulang[$n][410]). "</td>";
                echo "<td align='center'>" . (($pulang[$n][416]=="" ? 0 : $pulang[$n][416]) + ($pulang[$n][422]=="" ? 0 : $pulang[$n][422])) . "</td>";
                echo "<td align='center'>" . ($pulang[$n][404]=="" ? 0 : $pulang[$n][404]) . "</td>";
                echo "<td align='center'>" . ($pulang[$n][408]=="" ? 0 : $pulang[$n][408]) . "</td>";
                echo "<td align='center'>" . (($pulang[$n][415]=="" ? 0 : $pulang[$n][415]) + ($pulang[$n][421]=="" ? 0 : $pulang[$n][421])) . "</td>";
                echo "<td align='center'>" . ($pulang[$n][405]=="" ? 0 : $pulang[$n][405]) . "</td>";
                echo "<td align='center'>" . ($pulang[$n][409]=="" ? 0 : $pulang[$n][409]) . "</td>";
                echo "<td align='center'>" . (($pulang[$n][417]=="" ? 0 : $pulang[$n][417]) + ($pulang[$n][423]=="" ? 0 : $pulang[$n][423])) . "</td>";
                echo "<td align='center'>" . (($pulang[$n][412]=="" ? 0 : $pulang[$n][412]) + ($pulang[$n][413]=="" ? 0 : $pulang[$n][413]))  . "</td>";
                echo "<td align='center'>" . ($pulang[$n]["UMUM"]=="" ? 0 : $pulang[$n]["UMUM"]) . "</td>";
                echo "<td align='center'>" . ($pulang[$n]["PERUSAHAAN"]=="" ? 0 : $pulang[$n]["PERUSAHAAN"]) . "</td>";
                echo "<td align='center'>" . ($pulang[$n]["BPJS"]=="" ? 0 : $pulang[$n]["BPJS"]) . "</td>";
              }
            }
            if (date("Y-m-d") >= date("Y-m-d", strtotime($tanggal))) {
