<script>
	...
	$(document).ready(function(e){
        ...
        $("input[name='tgl1']").datepicker({
            ...
            var url = "<?php echo site_url('laporan/rl3a')?>/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
         $(".search").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            window.location = "<?php echo site_url("laporan/list_rl3a");?>/"+tgl1+"/"+tgl2;
        });
        // $(".search").click(function(){
	...
	<div class="box box-primary">
		<div class="box-body">
			...
			<table  width="100%" align="right" border="0">
				...
				<tr>
					<td class="text-center" colspan="2">TAHUN : <?php echo date("Y",strtotime($tgl1));?></td>
				</tr>
			</table>
					<br>
