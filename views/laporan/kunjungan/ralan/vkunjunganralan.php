<script>
	...
	$(document).ready(function(e){
        ...
        $(".print").click(function(){
            ...
            var url = "<?php echo site_url('laporan/cetakkunjunganralan')?>/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        $(".excel").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            var url = "<?php echo site_url('laporan/excelkunjunganralan')?>/"+tgl1+"/"+tgl2;
            window.location = url;
        });
         $(".search").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            window.location = "<?php echo site_url("laporan/kunjunganralan");?>/"+tgl1+"/"+tgl2;
        });
    });
</script>
<div class="col-xs-12">
