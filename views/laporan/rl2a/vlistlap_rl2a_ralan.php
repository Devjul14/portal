<script>
	...
	$(document).ready(function(e){
        ...
        $("input[name='tgl1']").datepicker({
            ...
            var url = "<?php echo site_url('laporan/rl2a_ralan')?>/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
         $(".search").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            window.location = "<?php echo site_url("laporan/list_rl2a_ralan");?>/"+tgl1+"/"+tgl2;
        });
        // $(".search").click(function(){
	...
	<div class="box box-primary">
		<div class="box-body">
			...
			<table  width="100%" align="right" border="0">
				...
				?>
				<tr>
					<td class="text-center" colspan="2">BULAN : <?php echo $bulan[date("m",strtotime($tgl1))]; ?></td>
				</tr>
				<tr>
				...
				<table border="1" cellspacing="0" cellpadding="1">
		                <thead>
		                    <tr>
			                    ...
			                    <td rowspan="4" class="text-center">JUMLAH KASUS BARU <br> 25 + 26</td>
			                    <td rowspan="4" class="text-center">JUMLAH KUNJU NGAN</td>
		                    </tr>
		                    <tr>
		                ...
		                <tbody>
                            ...
                            //     }
                                    ...
                                    echo "<td class='text-center'>".$jumlah_umum."</td>";
                                    ...
                                    $kasus_baru = (isset($p["HARI6"][$data->no_dtd]) ? $p["HARI6"][$data->no_dtd] : 0)+
                                          (isset($p["HARI7"][$data->no_dtd]) ? $p["HARI7"][$data->no_dtd] : 0);
                                    $kunjungan = ((isset($p["LAKI"][$data->no_dtd]) ? $p["LAKI"][$data->no_dtd] : 0)+(isset($p["PEREMPUAN"][$data->no_dtd]) ? $p["PEREMPUAN"][$data->no_dtd] : 0));
                                    echo "<td class='text-center'>".$kasus_baru."</td>";
                                    echo "<td class='text-center'>".$kunjungan."</td>";
		                            echo "</tr>";
		                    ...
		                    <tr>
	                            ...
	                            <td class='text-center'><?php echo $t_jml_baru; ?></td>
