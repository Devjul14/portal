<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('perawat/formskp');?>/"+id_perawat;
            window.location = url;
            // alert(url);
            return false; 
        });
        $(".edit").click(function(){
            ...
            var id_perawat = $("[name='id_perawat']").val();
            var url = "<?php echo site_url('perawat/formskp');?>/"+id_perawat + "/" + id;
            window.location = url;
            // alert(url);
            return false; 
        });
       ...
       $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            var id_perawat = $("[name='id_perawat']").val();
            window.location="<?php echo site_url('perawat/hapusskp');?>/"+id + "/" + id_perawat;
           return false;
       });
    });
</script>
