...
<script>
  ...
  $(document).ready(function(){
    $(".print").click(function(){
        ...
        var url                  = "<?php echo site_url('pembayaran_bu/cetak_kwitansi')?>/"+no_penerimaan+"/"+no_pembayaran;
        openCenteredWindow(url);
        return false;
    });
    $(".back").click(function(){
      window.location = "<?php echo site_url('pembayaran_bu/pembayaran_barang')?>";
      return false;
    });
...
<section class="invoice">
  ...
  <?php echo form_open("pembayaran_bu/simpanpembayaran",array("id"=>"formsimpan"));?>
