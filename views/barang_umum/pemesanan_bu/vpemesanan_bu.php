...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('pemesanan_bu/search_nomor');?>", 
                type: 'POST', 
        ...
        $(".add").click(function(){
            ...
            window.location = "<?php echo site_url('pemesanan_bu/formpemesanan_bu')?>/"+id;
            return false;
        });
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('pemesanan_bu/formpemesanan_bu')?>/";
            return false;
        });
        $(".edit").click(function(){
        ...
        $(".ya").click(function(){
            ...
            window.location = "<?php echo site_url('pemesanan_bu/hapuspemesanan_bu')?>/"+id+"/"+password;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('pemesanan_bu/reset_nomor');?>/";
            return false;
        });
