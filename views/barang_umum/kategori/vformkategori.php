...
<script>
    $(document).ready(function(){
        $(".batal").click(function(){
            window.location = "<?php echo site_url('master_bu/kategori');?>";
            return false;
        });        
    });
</script>
...
?>
	<div class="col-xs-12">
		<div class="box box-primary">
			<?php echo form_open('master_bu/simpankategori/'.$action,array("id"=>"formsubmit"));?>
			<div class="box-body">
				<div class="form-horizontal">
			        <div class="form-group">
		            	<label class="col-md-12 control-label">Kode</label>
		            	<div class="col-md-12">
		            		<input type="text" name="kode_kategori" class="form-control" value="<?php echo $kode_kategori; ?>" <?php echo $readonly ?>>
		                </div>
		            </div>
		            <div class="form-group">
