...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            var cari_kategori = $("input[name='cari_kategori']").val();
            $.ajax({
                url: "<?php echo site_url('master_bu/cari_kategori');?>", 
                type: 'POST', 
                data: {cari_kategori: cari_kategori}, 
                success: function(){
                    location.reload();
                }
            });
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('master_bu/formkategori')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('master_bu/formkategori')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('master_bu/hapuskategori')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('master_bu/reset_kategori');?>/";
            return false;
        });
           ...
           <table class="table table-bordered table-hover " id="myTable" >
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        echo "<tr id=data href='".$row->kode_kategori."'>";
        ...
        <div class="box-footer"> 
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="cari_kategori" value="<?php echo $this->session->userdata("cari_kategori") ?>" autocomplete="off"/>
                    </div>
                    <div class="col-md-1">
                        <div class="pull-left">
