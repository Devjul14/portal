...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('permintaan_bu/search_nomor');?>", 
                type: 'POST', 
        ...
        $(".add").click(function(){
            ...
            window.location = "<?php echo site_url('permintaan_bu/formpermintaan_bu')?>/"+id;
            return false;
        });
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('permintaan_bu/formpermintaan_bu')?>/";
            return false;
        });
        $(".edit").click(function(){
        ...
        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('permintaan_bu/hapuspermintaan_bu')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('permintaan_bu/reset_nomor');?>/";
            return false;
        });
        ...
        $(".rekap").click(function(){
            var tgl1        = $("[name='tgl1']").val();
            var tgl2        = $("[name='tgl2']").val();
            var url         = "<?php echo site_url('permintaan_bu/rekap_permintaan')?>/"+tgl1+"/"+tgl2;
