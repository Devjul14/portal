...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('distribusi_bu/search_history');?>", 
                type: 'POST', 
        ...
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('distribusi_bu/reset_history');?>/";
            return false;
        });
    });
</script>
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th width="150" class='text-center'>Status Lama</th>
                        <th width="150" class='text-center'>Status Baru</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        $i++;
                        echo "
                            <tr id=data href='".$row->id_ubah."'>
                                <td>".$i."</td>
                                <td>".$row->no_distribusi."</td>
                                <td>".$row->nama_bu." (".$row->merk.")</td>
                                <td>".$row->status_lama."</td>
                                <td>".$row->status_baru." </td>
                            </tr>";
                    }
                ?>
                </tbody>
