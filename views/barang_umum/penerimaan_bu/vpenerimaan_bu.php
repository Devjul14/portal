...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('penerimaan_bu/search_nomor');?>", 
                type: 'POST', 
        ...
        $(".add").click(function(){
            ...
            window.location = "<?php echo site_url('penerimaan_bu/formpenerimaan_bu')?>/"+id;
            return false;
        });
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('penerimaan_bu/formpenerimaan_bu')?>/";
            return false;
        });
        $(".edit").click(function(){
        ...
        $(".ya").click(function(){
            ...
            window.location = "<?php echo site_url('penerimaan_bu/hapuspenerimaan_bu')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('penerimaan_bu/reset_nomor');?>/";
            return false;
        });
        ...
        $(".rekap").click(function(){
            var tgl1        = $("[name='tgl1']").val();
            var tgl2        = $("[name='tgl2']").val();
            var url         = "<?php echo site_url('penerimaan_bu/rekap_penerimaan')?>/"+tgl1+"/"+tgl2;
        ...
        $(".simpan").click(function(){
            ...
            window.location = "<?php echo site_url('penerimaan_bu/simpantanggal_rekap')?>/"+no_penerimaan+"/"+tgl;
            return false;
        });
        var formattgl = "dd-mm-yy";
