...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('distribusi_bu/search_distribusi');?>", 
                type: 'POST', 
        ...
        $(".edit").click(function(){
            ...
            window.location = "<?php echo site_url('distribusi_bu/formdistribusi_bu')?>/"+id;
            return false;
        });
        ...
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('distribusi_bu/reset_distribusi');?>/";
            return false;
        });
    });
</script>
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th width="100" class='text-center'>Tujuan</th>
