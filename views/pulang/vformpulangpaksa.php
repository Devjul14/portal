...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('surat/cetakpulangpaksa'); ?>/" + no_reg + "/" + no_pasien;
...
<div class="col-xs-12 margin">
    <div class="box box-primary">
        <div class="box-header">
            <h3>SURAT PERNYATAAN PULANG ATAS PERMINTAAN SENDIRI</h3>
        </div>
        <div class="box-body">
            <?php echo form_open("surat/simpanpulangpaksa/" . $aksi, array("class" => "form-horizontal")); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select class="form-control" name="jk" required <?php echo $ubah; ?>>
                        <option>----</option>
                        <option value="L" <?php if ($jk == "L") : ?> selected <?php endif ?>>Laki-Laki</option>
                        <option value="P" <?php if ($jk == "P") : ?> selected <?php endif ?>>Perempuan</option>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" required name="alasan" class="form-control" value="<?php echo $alasan ?>" <?php echo $ubah; ?>>
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
        ...
        <div class="box-footer">
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> Pulang Paksa</button>
                    <?php if ($aksi == "edit") : ?>
