...
var mywindow;
    ...
    $(document).ready(function(){
        ...
        $("select[name='tindakan']").change(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    // location.reload();
                    window.location = "<?php echo site_url('radiologi/ekspertisi_inap');?>/"+no_pasien+"/"+no_reg+"/"+tindakan[0]+"/"+tindakan[3]+"/"+tindakan[4];
                }
            });
        });
        ...
        $('#formsave').submit(function (e) {
            ...
            if (dokter=="" || radiografer=="" || diagnosa==""){
                alert("Dokter dan Radiografer isi terlebih dahulu");
                e.preventDefault();
            } else {
                return;
            }
...
<div class="col-md-12">
    <?php
        echo form_open("radiologi/simpanekspertisi_inap/".$action,array("id"=>"formsave","class"=>"form-horizontal"));
    ?>
    <?php
        ...
        <div class="box-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" readonly class="form-control" name='dokter_radiologi' readonly value="<?php echo $row->kode_petugas;?>"/>
                    </div>
                    <label class="col-md-1 control-label">Radiografer</label>
                    <div class="col-md-2">
                        <input type="text" readonly class="form-control" name='radiografer' readonly value="<?php echo $q->radio;?>"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="diagnosa" readonly value="<?php echo $kas->diagnosa;?>"/>
                    </div>
                </div>
            </div>
        </div>
