...
var mywindow;
    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function(){
            ...
            var url = "<?php echo site_url('radiologi/cetakrekap_inap')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        ...
        $(".excel").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            var url = "<?php echo site_url('radiologi/excelrekap_inap')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        $(".cetak_pasien").click(function(){
            ...
            var url = "<?php echo site_url('radiologi/cetakpasien_inap')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        $(".cari").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("radiologi/rekap_inap");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
          $(".bg-blue").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url("radiologi/getpasien_rekap_inap");?>/"+tindakan+"/"+tgl1+"/"+tgl2, 
