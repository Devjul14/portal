 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $('.print').click(function(){
            ...
            var no_reg= $("[name='no_reg']").val();
            var url = "<?php echo site_url('kasir/cetakkwitansi');?>/"+no_pasien+"/"+no_reg;
            openCenteredWindow(url);
        });
        $('.cetakbarcode').click(function(){
            var no_pasien= $("[name='no_pasien']").val();
            var no_reg= $("[name='no_reg']").val();
            var url = "<?php echo site_url('pendaftaran/cetakbarcode');?>/"+no_pasien+"/"+no_reg+"/"+"RADIOLOGI";
            openCenteredWindow(url);
        });
        ...
        $("select[name='asal']").select2();
        $("select[name='ukuranfoto']").select2();
        ...
        $('.dataChange').click(function(evt) {
            ...
            if (jenis=='petugas' || jenis=='radiografer' || jenis=='dokter_pengirim'|| jenis=='asal' || jenis=='ukuranfoto' || jenis=='kali'){
                ...
                dataInputField.focus().blur(function(){
                    if (jenis=="nofoto" ||  jenis=="diagnosa")
                        var inputval = dataInputField.val();
                    else
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th class="text-center">Asal Foto</th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo "<td class='text-right'><a href='#' class='dataChange ukuranfoto' id='".$data->id."'>".($data->ukuranfoto=="" ? "---Pilih Ukuran Foto---" : $data->ukuranfoto)."</a></td>";
                            echo "<td class='text-right'><a href='#' class='dataChange kali' id='".$data->id."'>".($data->kali=="" ? "---Berapa Kali---" : $data->kali)."</a></td>";
                            echo "<td class='text-right'><a href='#' class='dataChange diagnosa' id='".$data->id."'>".($data->diagnosa=="" ? "-" : $data->diagnosa)."</a></td>";
                ...
                <tfoot>
                    <tr>
                        <th colspan="10" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th>
                    ...
                    <?php if ($row->status_bayar=="TAGIH"): ?>
                        <tr>
                            <th colspan="10" style="vertical-align: middle" ><span class="pull-right">Sharing</span></th>
                    ...
                    <?php endif ?>
                    <tr>
                        <th colspan="10" style="vertical-align: middle" ><?php echo $tgl_pembayaran;?><span class="pull-right">Total</span></th>
