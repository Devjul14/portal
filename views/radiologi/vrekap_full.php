    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function(){
            ...
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('radiologi/cetakrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('radiologi/cetakrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
        ...
        $(".cetak_pasien").click(function(){
            ...
            var url = "<?php echo site_url('radiologi/cetakpasien_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        ...
        $(".excel").click(function(){
            ...
            var tindakan = $("[name='tindakan']").val();
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('radiologi/excelrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('radiologi/excelrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
        ...
        $(".cari").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("radiologi/rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
        $(".punya").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url("radiologi/getpasien_rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2,
                success: function(result){
                    ...
                    $.each(JSON.parse(result), function(key, value){
                        ...
                        content += "<td class='text-center'>"+(value.no_pasien == undefined || value.no_pasien == "" ? "-" : value.no_pasien)+"</td>";
                        content += "<td>"+value.nama_pasien+"</td>";
                        content += "<td>"+value.tanggal+"</td>";
                        content += "<td>"+value.pemeriksaan+"</td>";
                        content += "<td>"+(value.nama_poli == undefined || value.nama_poli == "" ? "-" : value.nama_poli)+"</td>";
                        content += "<td>"+(value.nama_ruangan == undefined || value.nama_ruangan == "" ? "-" : value.nama_ruangan)+"</td>";
                        content += "<td>"+(value.nama_kelas == undefined || value.nama_kelas == "" ? "-" : value.nama_kelas)+"</td>";
                        content += "<td>"+(value.nama_kamar == undefined || value.nama_kamar == "" ? "-" : value.nama_kamar)+"</td>";
