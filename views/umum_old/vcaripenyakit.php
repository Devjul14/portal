...
<script>
    $(document).ready(function(){
		...
		$(".simpan").click(function(){
			var nama_penyakit = $("input[name='cari']").val();
			changeData(nama_penyakit);
		});
		$("tr#selek").dblclick(function(){
			close();
			var url = $(this).attr("href");
			var id = url.split("/");
			window.opener.$("input[name='id_penyakit']").val(id[0]);
			window.opener.$("input[name='nama_penyakit']").val(id[1]);
			return false;
		});
    });
var changeData = function(strkode){
	var arrayData = {nama_penyakit: strkode};
	$.ajax({
		url: "<?php echo site_url('umum/simpanpenyakit');?>", 
		type: 'POST', 
		data: arrayData, 
		success: function(){
	    ...
	    <div class="col-lg-12">
	        <div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content" >
	            	<?php echo form_open("umum/caripenyakit",array("id"=>"formcari"));?>
	                <div class="form-horizontal">
	                	<div class="form-group">
                        ...
                        <table class="table table-hover">
							...
							<?php
								...
								foreach ($q->result() as $row){
									$i++;
									echo "
										<tr id=selek href='".$row->id_penyakit."/".$row->nama_penyakit."'>
										  <td>".$i."</td>
