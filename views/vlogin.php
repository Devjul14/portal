...
<head>
    ...
    <title>RS TINGKAT III 03.06.01 CIREMAI | Log in</title>
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body box box-solid">
            ...
            <div class="box-header"><h3 class="text-center" style="color:#fff"><b>RS CIREMAI</b></h3></div>
        ...
        <div class="login-box-msg"><span class="label bg-blue">&copy; 2019 | TRUSTME - we respect, trust and care</span></div><br>
