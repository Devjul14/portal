 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $("[name='tindakan']").change(function(){
            ...
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan",
                method : "POST",
        ...
        $("[name='penunjang']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_penunjang",
                method : "POST",
        ...
        $("[name='tindakan_radiologi']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_radiologi",
                method : "POST",
                data : {no_reg: no_reg, jenis: jenis, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $("[name='ambulance']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_ambulance",
                method : "POST",
                data : {no_reg: no_reg, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $("[name='gizi']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_gizi",
                method : "POST",
                data : {no_reg: no_reg, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $("[name='lab']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_lab",
                method : "POST",
                data : {no_reg: no_reg, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $("[name='pa']").change(function(){
            ...
            var tindakan    = $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>parsial/addtindakan_pa",
                method : "POST",
                data : {no_reg: no_reg, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $('.back').click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('parsial/getcaripasien_ralan');?>",
                success : function(result){
                    window.location = "<?php echo site_url('parsial/parsial_ralan');?>";
                },
        ...
        $('.print').click(function(){
            ...
            var no_reg= $("[name='no_reg']").val();
            var url = "<?php echo site_url('parsial/cetakkwitansi');?>/"+no_rm+"/"+no_reg;
        ...
        $('.hapus').click(function(){
            var id= $(this).attr("id");
            $.ajax({
                url : "<?php echo base_url();?>parsial/hapustindakan",
                method : "POST",
                data : {id: id},
                success: function(data){
                     location.reload();
        ...
        $('.okbayar').click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url();?>parsial/simpantransaksi",
                method : "POST",
    ...
    var changeData = function(value,id){
        $.ajax({
            url: "<?php echo site_url('parsial/changedata');?>", 
            type: 'POST', 
...
<?php
    if($q->num_rows()>0){
        ...
        if ($disc_nominal+$sharing+$total==0)
            $disc_persen = 0;
        else
        ...
        <div class="box-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" readonly class="form-control" name='status_bayar' readonly value="RALAN"/>
                    </div>
                </div>
                <div class="form-group">
