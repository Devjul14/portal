...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="subnav">
				<div class='span12'>
					<div class='text-center'><h4>TINDAKAN</h4></div>
				</div>
			</div><br>
			<div class="row-fluid">
				<div class='span12'>
					<table cellspacing=2 cellpadding=5 id=print width=100%>
						<tr>
							<th width=20px>No.</th>
							<th width=350px>Keluhan Skrng</th>
			...
			<div class="subnav">
				<div class='span12'>
					<div class='text-center'><h4>OBAT</h4></div>
				</div>
			</div><br>
			<div class="row-fluid">
				<div class='span12'>
					<table cellspacing=2 cellpadding=5 id=print width=100%>
						<tr>
							...
							<th>Aturan Pakai</th>
							<th width=100px align=right>Dosis</th>
						</tr>
						<?php
							$i = 1;
							foreach ($q2->result() as $data) {
								echo "<tr>
										  ...
										  <td style='text-align:right'>".$data->jml_pemakaian."</td>
									  </tr>";
							}
						?>
					</table>
