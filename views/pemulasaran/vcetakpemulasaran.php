...
<script>
    ...
    <br>
    <p>
        <h4 align="center"><b>SURAT PERNYATAAN</b></h4>
    </p>
    <br>
    <br>
    <br>
    ...
    <table width="100%" class="laporan2">
        ...
        <tr>
            <td>Jenis Kelamin</td>
            <td>: <?=($q2->jk=="L" ? "Laki-Laki" : "Perempuan")?>
            </td>
        </tr>
        <tr>
            <td>Umur</td>
    ...
    <p>
        Kami Pihak Keluarga <b><?php echo $q2->setuju=="setuju" ? "SETUJU" : "TIDAK SETUJU";?></b> untuk dilakukan tindakan pemulasaran dengan Protocol Covid-19 Terhadap :
    </p>
    <table width="100%" class="laporan2">
        <tr>
            <td width="40%">Nama</td>
        ...
        <tr>
            <td>Kesatuan</td>
            <td>: <?php echo $q->nama_kesatuan ?></td>
        </tr>
        <tr>
            <td>Alamat</td>
