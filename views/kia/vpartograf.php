...
<div class="col-xs-12">
	...
	<?php echo form_open("kia/partograf",array("id"=>"formcari"));?>
			...
			<table id="myTable" class="table table-bordered">
				<thead>
					<tr class="bg-navy">
					   ...
					   <th width="120px">No. KK</th>
					   <th width="130x">No. Pasien</th>
					   <th>Nama</th>
					</tr>
				</thead>
				<tbody>
					<?php
						...
						foreach ($q->result() as $row){
							...
							echo "<td class=text-center>".$row->no_pasien."</td>
								  <td>".anchor("kia/partografdetail/".$row->id_pendaftaran."/".$row->id_pasien,$row->nama_pasien,array("class"=>"btn btn-success btn-sm"))."</td>
								  </tr>";
						}
					?>
				</tbody>
