...
<script>
    $(document).ready(function(){
		...
		$("tr#selek").dblclick(function(){
			...
			var id = url.split("/");
			window.opener.$("input[name='id_detail_bumil']").val(id[0]);
			window.opener.$("input[name='nama_detail_bumil']").val(id[1]);
			window.opener.$("input[name='tindakan']").val(id[0]);
			window.opener.$("input[name='id_tindakan']").val(id[0]);
			window.opener.$("input[name='nama_tindakan']").val(id[1]);
			return false;
		});
    })
</script>
	    ...
	    <div class="col-lg-12">
	        <div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content" >
	            	<?php echo form_open("kia/caritindakan",array("id"=>"formcari"));?>
	                <div class="form-horizontal">
                        <div class="form-group">
                        ...
                        <table class="table table-hover">
							...
							<?php
								...
								foreach ($q->result() as $row){
									$i++;
									echo "<tr id=selek href='".$row->id_tindakan."/".$row->nama_tindakan."'>
										  <td>".$i."</td>
