...
var mywindow;
    ...
    $(document).ready(function(){
        ...
        $('.back').click(function(){
            ...
            window.location = "<?php echo site_url('grouper/viewgrouper_inap');?>/"+no+"/"+cari_no;
            // $.ajax({
            //     type  : "POST",
        ...
        $("select[name='tindakan']").change(function(){
            ...
            window.location = "<?php echo site_url('grouper/ekspertisiradiologi_inap');?>/"+no_pasien+"/"+no_reg+"/"+tindakan[0]+"/"+tindakan[3]+"/"+tindakan[4];
        });
