 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $("[name='tindakan_inap']").change(function(){
            ...
            $.ajax({
                url : "<?php echo base_url();?>pendaftaran/addtindakan_inap/inap",
                method : "POST",
        ...
        $("[name='ambulance']").change(function(){
            ...
            var tindakan= $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>pendaftaran/addtindakan_inap/ambulance",
                method : "POST",
        ...
        $("[name='penunjang']").change(function(){
            ...
            var tindakan= $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>pendaftaran/addtindakan_inap/penunjang",
                method : "POST",
                data : {no_reg: no_reg, kode_kelas: kode_kelas, tindakan: tindakan, qty: qty, tanggal: tanggal},
                success: function(data){
                     location.reload();
        ...
        $("[name='operasi']").change(function(){
            ...
            var tindakan= $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>pendaftaran/addtindakan_inap/operasi",
                method : "POST",
                data : {no_reg: no_reg, kode_kelas: kode_kelas, tindakan: tindakan, qty: qty, tanggal: tanggal},
                success: function(data){
                     location.reload();
        ...
        $('.back').click(function(){
            var no = $("[name='no_rm']").val();
            var cari_noreg = $("[name='no_reg']").val();
            window.location = "<?php echo site_url('grouper/viewgrouper_inap');?>/"+no+"/"+cari_noreg;
            // $.ajax({
            //     type  : "POST",
            //     data  : {cari_noreg:cari_noreg},
                // url   : "<?php echo site_url('grouper/getcaripasien_inap');?>",
        ...
        $('.hapus_inap').click(function(){
            var id= $(this).attr("id");
            $.ajax({
                url : "<?php echo base_url();?>pendaftaran/hapusinap",
                method : "POST",
                data : {id: id},
                success: function(data){
                     location.reload();
                ...
                <tbody>
                    <?php
                        ...
                        foreach($t1->result() as $data){
                            ...
                            echo "<td class='text-right'><a href='#' class='".$dis." tagihan dataChange' id='".$data->id."'>".number_format($data->jumlah,0,'.','.')."</a></td>";
                            echo "<td class='text-right'><a href='#' class='".$dis." qty dataChange' id='".$data->id."'>".number_format($data->qty,2,'.','.')."</a></td>";
                        ...
                        foreach($a1->result() as $data){
                            ...
                            echo "<td class='text-right'><a href='#' class='".$dis." tagihan dataChange' id='".$data->id."'>".number_format($data->jumlah,0,'.','.')."</a></td>";
                            echo "<td class='text-right'><a href='#' class='".$dis." qty dataChange' id='".$data->id."'>".$data->qty."</a></td>";
