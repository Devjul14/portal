...
<table cellspacing="2" cellpadding="1"  width="100%" align="right"border="0" rules="rows">
	...
	<tbody>
		<?php
	        ...
	        $total += $row->jumlah;
	        	echo "<tr>";
	            echo "<td style='vertical-align:top' align='center'>".$i."</td>";
	            echo "<td style='vertical-align:top'>".date("d/m/y",strtotime($row->tanggal))."</td>";
                echo "<td style='vertical-align:top'>".$row->nama_obat."</td>";
	            echo "<td style='vertical-align:top' align='right'>".$row->satuan."</td>";
	            echo "<td style='vertical-align:top' align='right'>".$row->qty."</td>";
	            echo "<td style='vertical-align:top' align='right'><span class='pull-left'></span>".number_format($jumlah,0,',','.')."</td>";
	            echo "<td style='vertical-align:top' align='right'><span class='pull-left'></span>".number_format($row->jumlah,0,',','.')."</td>";
	            echo "</tr>";
	        $i++;
	    }
	    ?>
