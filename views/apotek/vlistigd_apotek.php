...
var mywindow;
    ...
    $(document).ready(function(e){
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('apotek/search_igd');?>",
                type: 'POST',
                data: arrayData,
                success: function(){
                    location.reload();
        ...
        $(".pdf").click(function(){
            ...
            var url = "<?php echo site_url('apotek/formuploadpdf');?>/igd/"+id;
            window.location = url;
            return false;
        });
        $(".reset").click(function(){
            var url = "<?php echo site_url('apotek/reset_igd');?>";
            window.location = url;
            return false;
        });
        ...
        $(".terima1").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('apotek/terima')?>/"+id;
            return false;
        });
        $(".obat").click(function(){
            var id = $(".bg-gray").attr("href");
            ...
            if (phone==""){
                ...
                openCenteredWindow(url);
                window.location = "<?php echo site_url('apotek/obat')?>/"+id;
                return false;
            }
        });
        $(".respond").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek/respond')?>/"+id;
            openCenteredWindow(url);
        });
    });
</script>
