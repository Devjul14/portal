...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".pdf").click(function(){
            ...
            var url = "<?php echo site_url('apotek/formuploadpdf');?>/inap/"+id;
            window.location = url;
            return false;
        });
        $(".edit").click(function(){
        ...
        $(".viewterima").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek/viewterimaapotek_inap');?>/"+id;
            window.location = url;
            return false; 
        });
        ...
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('apotek/reset_inap');?>/";
            // location.reload();
            return false;
        });
        ...
        $(".terima").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('apotek/terima_inap')?>/"+id;
            return false;
        });
        $(".obat").click(function(){
            var id = $(".bg-gray").attr("href");
            ...
            if (phone==""){
                ...
                openCenteredWindow(url);
                window.location = "<?php echo site_url('apotek/obat_inap')?>/"+id;
                return false;
            }
        });
        $(".respond").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek/respond_inap')?>/"+id;
            openCenteredWindow(url);
        });
    });
