...
header("Content-Disposition: attachment; filename=Rekap_Radiologi_Ralan".date('YmdHis').".xls");
...
<link rel="stylesheet" href="<?php echo base_url();?>css/print.css">
    <h4 style="margin-left: 250px; width: 25cm;" align="center">LAPORAN PEMERIKSAAN LAB RAWAT JALAN DAN RAWAT INAP <br>
        ...
        <table cellspacing="0" cellpadding="2" border="1" width="100%">
            ...
            <?php
                ...
                foreach($t->result() as $data){
                    ...
                    echo "<td class='text-right'>".$jumlah_inap." ".($data->kode_tindakan=="L158" || $data->kode_tindakan=="L160" || $data->kode_tindakan=="L047" ? "(".(isset($p_inap["positif"][$data->kode_tindakan]) ? $p_inap["positif"][$data->kode_tindakan] : 0).",".(isset($p_inap["negatif"][$data->kode_tindakan]) ? $p_inap["negatif"][$data->kode_tindakan] : 0).")" : "")."</td>";
