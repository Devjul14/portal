		...
		<td><table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr>
                        ...
                        <th class='text-center'>Tanggal/ Jam Ambil Sampel</th>
                ...
                <tbody>
                    <?php
						...
						$t1 = new DateTime($data->jam_lab);
						$t2 = new DateTime($data->terima_lab);
						$h  = $t1->diff($t2)->h;
						$is  = $t1->diff($t2)->i;
						$s  = $t1->diff($t2)->s;
                            ...
                            echo "<td>".$tanggal1."</td>";
                        	echo "<td class='text-center'>".($data->terima_lab=="0000-00-00 00:00:00" ? "-" : date("d-m-Y H:i:s",strtotime($data->terima_lab)))."</td>";
                        	echo "<td>".date("H:i:s",strtotime($data->periksa_lab))."</td>";
                            echo "<td>".date("H:i:s",strtotime($data->jam_lab))."</td>";
...
<?php echo $q->hasil_pemeriksaan ?></textarea></font>
	...
	<table width="100%" align="right">
		...
		<tr>
				<td></td>
				<td width="25%"> &nbsp;Labolatorium Klinik</td>
		</tr>
	</table>
