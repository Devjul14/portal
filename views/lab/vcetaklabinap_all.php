...
<link rel="stylesheet" href="<?php echo base_url();?>css/print.css">
 <link rel="stylesheet" href="<?php echo base_url();?>css/bootstrap.css">
	...
	<script>
        ...
        function getttd1(){
			var ttd = "<?php echo site_url('ttddokter/getttdanalys/31930781711173');?>";
		...
		<td>
			<table cellspacing="2" cellpadding="1"  width="100%" align="right"border="0">
				<thead>
					...
					<th align="left" width="250"><strong>Jenis Pemeriksaan <hr style="margin-bottom: 1px; margin-top: 3px"></strong></th>
          ...
          foreach ($k1->result() as $row){
            if ($row->kode_judul!=15){
              $merah = "";
              // $hasil = (float)$row->hasil;
              $hasil = (isset($hs[$row->kode][$row->pemeriksaan][$row->tanggal]) ? $hs[$row->kode][$row->pemeriksaan][$row->tanggal]->hasil : "");
              if ($judul!=$row->judul){
                $i = 1;
                echo "<tr>";
              ...
              $namaanalys = (isset($analys[31930781711173]) ? $analys[31930781711173] : "");
              ...
              if (isset($h[$row->kode_tindakan])){
                if ($header!=$h[$row->kode_tindakan]){
                  ...
                  if ($hasil!=""){
                    echo "<tr>";
                    echo "<td>&nbsp;</td>";
                    echo "<td align='left'>&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;".date("d-m-Y",strtotime($row->tanggal))."&nbsp&nbsp;".$row->nama."</td>";
                    echo "<td align='left'>".(strlen($row->kode)<4 ? "" : "<label class='text-".$merah."'>".$hasil."&nbsp;".$row->satuan."</label>")."</td>";
