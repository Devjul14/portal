...
var mywindow;
    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function(){
            ...
            //var url = "<?php echo site_url('lab/cetakrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('lab/cetakrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('lab/cetakrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
        ...
        $(".cetak_pasien").click(function(){
            ...
            if (tindakan == "L160" || tindakan == "L158" || tindakan == "L047") {
                var url = "<?php echo site_url('lab/cetakpasien_fullk')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('lab/cetakpasien_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
            openCenteredWindow(url);
        });
        ...
        $(".excel").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            //var url = "<?php echo site_url('lab/excelrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            if ($("input.semua").is(":checked")) {
                var url = "<?php echo site_url('lab/excelrekap_full')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }else{
                var url = "<?php echo site_url('lab/excelrekap_full2')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            }
            openCenteredWindow(url);
        });
        $(".cari").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("lab/rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
        $(".punya").click(function(){
            ...
            if (tindakan == "L160" || tindakan == "L158" || tindakan == "L047") {
                $.ajax({
                    url: "<?php echo site_url("lab/getpasien_rekap_full");?>/"+tindakan+"/"+tgl1+"/"+tgl2,
                    success: function(result){
                        ...
                        content += '        <th class="text-center">Hasil</th>';
                        ...
                        $.each(result["list"], function(key, val){
                            ...
                            content += "<td>"+(result["ekspertisi_lab"] == undefined || result["ekspertisi_lab"][val.no_reg] == undefined || result["ekspertisi_lab"][val.no_reg].hasil == null ? "-" : result["ekspertisi_lab"][val.no_reg].hasil)+"</td>";
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach($t->result() as $data){
                                ...
                                echo "<td class='text-right'>".$jumlah_ralan." ".($data->kode_tindakan=="L158" || $data->kode_tindakan=="L160" || $data->kode_tindakan=="L047"  ? "(".(isset($p["positif"][$data->kode_tindakan]) ? $p["positif"][$data->kode_tindakan] : 0).",".(isset($p["negatif"][$data->kode_tindakan]) ? $p["negatif"][$data->kode_tindakan] : 0).")" : "")."</td>";
                                //inap
                                ...
                                $jumlah_inap." ".($data->kode_tindakan=="L158" || $data->kode_tindakan=="L160" || $data->kode_tindakan=="L047" ? "(".(isset($p_inap["positif"][$data->kode_tindakan]) ? $p_inap["positif"][$data->kode_tindakan] : 0).",".(isset($p_inap["negatif"][$data->kode_tindakan]) ? $p_inap["negatif"][$data->kode_tindakan] : 0).")" : "")."</td>";
