...
<link rel="stylesheet" href="<?php echo base_url();?>css/print.css">
    <h4 align="center">LAPORAN PASIEN PEMERIKSAAN LABOLATORIUM KLINIK RAWAT JALAN DAN RAWAT INAP<br>
                    ...
                    <tbody>
                        <?php
                                foreach ($q["list"] as $value) {
                                    ...
                                    $ekspertisi_lab = ($q["ekspertisi_lab"][$value->no_reg]);
                                    ...
                                    echo"
                                        ...
                                        <td class='text-center'>".($ekspertisi_lab->hasil == "undefined" || $ekspertisi_lab->hasil == "" ? "" : $ekspertisi_lab->hasil)."</td>
