...
var mywindow;
    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function(){
            ...
            var url = "<?php echo site_url('lab/cetakrekap_ralan')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        ...
        $(".excel").click(function(){
            ...
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            var url = "<?php echo site_url('lab/excelrekap_ralan')?>/"+tindakan+"/"+tgl1+"/"+tgl2;
            openCenteredWindow(url);
        });
        $(".cari").click(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            var tindakan = $("[name='tindakan']").val();
            window.location = "<?php echo site_url("lab/labrekap_ralan");?>/"+tindakan+"/"+tgl1+"/"+tgl2;
        });
        $(".bg-blue").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url("lab/getpasien_rekap");?>/"+tindakan+"/"+tgl1+"/"+tgl2,
    ...
    <div class='modal-dialog'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                ...
                <div><button class="cetak_pasien btn btn-primary">Cetak</button></div>
            </div>
        </div>
    </div>
</div>
