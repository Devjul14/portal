...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            var arrayData = {tgl1: tgl1,tgl2: tgl2,kode_dokter: kode_dokter,dokter: dokter};
            $.ajax({
                url: "<?php echo site_url('lab/search_labralan');?>", 
                type: 'POST', 
                data: arrayData, 
                success: function(){
                    location.reload();
        ...
        $(".ya_rejected").click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('lab/batal');?>/"+id,
                success : function(result){
                    location.reload();
                },
                error: function(result){
        ...
        $(".reset").click(function(){
            var url = "<?php echo site_url('lab/reset_labralan');?>";
            window.location = url;
            return false;
        });
        ...
        $(".detail").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('lab/detaillab_ralan');?>/"+id;
            window.location = url;
            return false; 
        });
        $(".ekspertisi").click(function(){
            ...
            $.ajax({
                type  : "POST",
                data  : {no_reg:no[1]},
                url   : "<?php echo site_url('lab/cekkasir_detail');?>",
                success : function(result){
                    ...
                    if (jml>0){
                        ...
                        var id = $(".bg-gray").attr("href");
                        var url = "<?php echo site_url('lab/ekspertisi');?>/"+id;
                        window.location = url;
                    }
                },
                error: function(result){
        ...
        $(".terima").click(function(){
            ...
            if (status_bayar==""){
                ...
                window.location = "<?php echo site_url('lab/terima')?>/"+id;
            }
            return false;
        });
        $(".periksa").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('lab/periksa')?>/"+id;
            return false;
        });
        $(".respond").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('lab/respond')?>/"+id;
            openCenteredWindow(url);
        });
        $(".upload").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('lab/formuploadpdf_ralan');?>/"+id;
            window.location = url;
            return false; 
        });
        $(".rekap").click(function(){
            var url = "<?php echo site_url('lab/labrekap_ralan');?>/all";
            window.location = url;
            return false; 
        });
    });
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        ...
                        echo "<tr id=data href='".$row->no_pasien."/".$row->no_reg."' status_bayar='".$row->status_bayar."'>" ;
                ...
                <div class="col-xs-8">
                    <div class="pull-right">
                        <div class="btn-group">
                            ...
                            <!-- <button class="terima btn bg-teal" type="button"> Terima</button> -->
                            <button class="ekspertisi btn btn-success" type="button"> Ekspertisi</button>
                            <button class="periksa btn bg-navy" type="button"> Periksa</button>
                            <button class="detail btn btn-warning" type="button"><i class="fa fa-edit"></i> Terima</button>
