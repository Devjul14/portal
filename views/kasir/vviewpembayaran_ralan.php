 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        $("[name='tindakan_lab']").change(function(){
            ...
            var tindakan= $(this).val();
            $.ajax({
                url : "<?php echo base_url();?>kasir/addtindakan_lab",
                method : "POST",
                data : {no_reg: no_reg, jenis: jenis, tindakan: tindakan},
                success: function(data){
                     location.reload();
        ...
        $('.okbayar').click(function(){
            ...
            if (username_kasir!="" && password_kasir!=""){
                ...
                $.ajax({
                    ...
                    method : "POST",
                    data : {no_reg: no_reg,username_kasir: username_kasir, disc_nominal: disc_nominal,dp_nominal: dp_nominal, sharing: sharing, total: total, status_bayar : status_bayar},
                    success: function(data){
                        location.reload();
                    },
                    error: function(data){
    ...
    function gettotal(){
        ...
        if ($("[name='sharing']").hasClass="hide")
            ...
            sharing = $("[name='sharing']").val().replace(/\D/g,'');
        total = subtotal-dp_nominal-disc_nominal-sharing;
    ...
    <div class="box box-primary">
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                <tbody>
                    <?php
                        ...
                        // $total_rad2 = 0;
                        // foreach($k2->result() as $datar2){
                        //     $total_rad2 += $datar2->jumlah;
                        // }
                        // if ($total_rad2>0){
                        //     echo "<tr>";
                        //     echo "<td>".$i++."</td>";
                        //     echo "<td>Radiologi</td>";
                        //     echo "<td class='text-right'>".number_format($total_rad2,0,'.','.')."</td>";
                        //     echo "</tr>";
                        // }
                        // $subtotal += $total_rad2;
                ...
                <tfoot>
                    ...
                    <input type="hidden" name="status_bayar" value="<?php echo $row->status_bayar;?>">
        ...
        <div class="box-footer">
            <div class="col-sm-12">
                ...
                <div class="col-sm-2">
                    <select class="form-control" name="tindakan_lab">
                        <option value="">---Tindakan Lab---</option>
                        <?php 
                            foreach ($tl->result() as $keyl) {
                                echo '<option value="'.$keyl->kode_tindakan.'">'.$keyl->nama_tindakan.'</option>';
                            }
                        ?>
                    </select>
                </div>
