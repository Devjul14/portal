...
<script>
    ...
    function getttd(){
        var ttd = "<?php echo site_url('ttddokter/getttdpetugas/'.$rq->petugas_kasir);?>";
...
<body>
    ...
    <table cellpadding="2" cellspacing="2" width="100%">
        ...
        <?php
            ...
            // if ($total_rad1>0){
            //     echo "<tr>";
            //     echo "<td>".$i++.". Radiologi</td>";
            //     echo "<td align='right'>".number_format($total_rad1,0,'.','.')."</td>";
            //     echo "<td align='right'>".number_format($total_rad1,0,'.','.')."</td>";
            //     echo "</tr>";
            // }
            // $subtotal += $total_rad1;
            ...
            //     echo "<tr>";
            //     echo "<td>".$i++.". Radiologi</td>";
            //     echo "<td align='right'>".number_format($total_rad2,0,'.','.')."</td>";
            //     echo "<td align='right'>".number_format($total_rad2,0,'.','.')."</td>";
            //     echo "</tr>";
            // }
            // $subtotal += $total_rad2;
