...
<script>
    ...
    $(document).ready(function(e) {
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('pendaftaran/cetaknarkoba'); ?>/" + no_reg + "/" + no_rm + "/" + jenis;
        ...
        <div class="box-body">
            <div class="form-horizontal">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Anamnesis</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="anamnesis" value="<?php echo $q2->anamnesis ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Pemeriksaan Fisik</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fisik" readonly value="<?php echo $q2->fisik ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6">
