<script>
    function pencarian() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('suket/getcarino_se'); ?>",
            success: function(result) {
                window.location = "<?php echo site_url('suket/list_se'); ?>";
            },
    ...
    $(document).ready(function(e) {
        ...
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('suket/cetaklistno_se') ?>/" + tgl1 + "/" + tgl2;
        ...
        $(".reset").click(function() {
            var url = "<?php echo site_url('suket/reset_se'); ?>";
            window.location = url;
        });
    });
            ...
            <table class="table table-bordered table-hover " id="myTable">
                ...
                <tbody>
                    ...
                    foreach ($q3->result() as $row) {
                        echo "<tr id=data no_surat='" . $row->no_surat . "' tanggal='" . date("d/m/Y", strtotime($row->tanggal)) . "' uraian='" . $row->uraian . "' asal_surat='" . $row->asal_surat . "' perihal='" . $perihal . "' lampiran='" . $lampiran . "' ket='" . $ket . "'>";
                        $bulan = array("", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII");
                        $no_surat = $row->no_surat . "/ SE / " . $bulan[(int)(date("m", strtotime($row->tanggal)))] . "/ " . date("Y", strtotime($row->tanggal));
...
<div class='modal modalrekap no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Rekap SE Keluar</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
