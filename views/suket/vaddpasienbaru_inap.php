...
var mywindow;
    ...
    function prosessinkron(){
        ...
        $.ajax({
            ...
            url   : "<?php echo site_url('pendaftaran/prosessinkron/ranap');?>",
            success : function(result){
                var ur = "<?php echo site_url('pendaftaran/addpasienbaru_inap/n/n/n');?>/"+no_rm+"/"+no_reg;
                window.location = ur;
            },
            error: function(result){
                console.log(result);
        ...
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-horizontal">
                    <?php
                        if (!$lock) echo form_open("surat/simpanpasienbaru_inap/".$action,array("id"=>"formsave","class"=>"form-horizontal"));
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label">Tgl Rekam Medis</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" readonly name="tanggal" value="<?php echo $tanggal;?>">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class='modal-body'>
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="input-group">
                                <input class="form-control" type="text" name="cari_no" placeholder="No. KTP/ No. BPJS/ NIP"/>
                                <span class="input-group-btn">
                            ...
                            <div class="ljt hide">
                                <div class="pull-right"> 
                                    ...
                                    <button class="lanjut btn btn-success">Ambil</button>
                                </div>
                            </div>
                        </div>
                    </div>
