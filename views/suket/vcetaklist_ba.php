...
<body class="page">
    ...
    <p align="center"><b>REKAP NO B.A</b></p>
    ...
    <table class="laporan">
        ...
        <tbody>
            ...
            foreach ($q->result() as $row) {
                echo "<tr id=data href='" . $row->no_surat . "' tanggal='" . date("Y/m/d", strtotime($row->tanggal)) . "' asal_surat='" . $row->asal_surat . "' perihal='" . $row->perihal . "' ket='" . $row->ket . "' kepada='" . $row->kepada . "'>";
