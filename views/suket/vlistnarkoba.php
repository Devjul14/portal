<script>
    ...
    function pencarian() {
        ...
        $.ajax({
            ...
            success: function(result) {
                window.location = "<?php echo site_url('suket/listnarkoba'); ?>";
            },
    ...
    $(document).ready(function(e) {
        ...
        $(".cetaklistnarkoba").click(function() {
            var tgl1 = $("[name='list_tgl1']").val();
            var tgl2 = $("[name='list_tgl2']").val();
            var url = "<?php echo site_url('suket/cetaklistnarkoba') ?>/" + tgl1 + "/" + tgl2;
            openCenteredWindow(url);
            return false;
        });
        $(".listnarkoba").click(function() {
            $(".modallistnarkoba").modal("show");
            return false;
        });
        ...
        $(".reset").click(function() {
            window.location = "<?php echo site_url('suket/reset_narkoba'); ?>/";
            return false;
        });
        $(".detailnarkoba").click(function() {
            var no_rm = $(".bg-gray").attr("no_pasien");
            var no_reg = $(".bg-gray").attr("no_reg");
            var jenis = $(".bg-gray").attr("jenis");
            var url = "<?php echo site_url('suket/detailnarkoba') ?>/" + no_rm + "/" + no_reg + "/" + jenis;
            window.location = url;
            return false;
        });
    ...
    <div class="box box-primary">
            ...
            <table class="table table-bordered table-hover " id="myTable">
                ...
                <tbody>
                    ...
                    foreach ($q3 as $key => $row) {
                        ...
                        $nomor_surat = $row->nomor_surat . "/ SKN/ " . $bulan[(int)(date("m", strtotime($row->tgl_insert)))] . "/ " . date("Y", strtotime($row->tgl_insert));
        ...
        <div class="box-footer">
            <div class="row">
                <div class="col-xs-12">
                    <div class="pull-right">
                        <button class="listnarkoba btn btn-sm btn-primary" type="button"><i class="fa  fa-file"></i> Rekap</button>
                        <button class="detailnarkoba btn btn-sm btn-success" type="button"> <i class="fa  fa-search-plus"></i> Detail</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class='modal modallistnarkoba no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Rekap Surat Keterangan Narkoba</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
            ...
            <div class='modal-footer'>
                <div class="pull-right">
                    <button class="cetaklistnarkoba btn btn-success">Cetak</button>
                </div>
            </div>
        </div>
    </div>
