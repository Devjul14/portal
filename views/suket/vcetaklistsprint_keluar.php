...
<body class="page">
    ...
    <p align="center"><b>REKAP SPRINT KELUAR</b></p>
    <p align="center"><b> NO. SPRINT <?php echo date("d-m-Y", strtotime($tgl1)); ?> s/d <?php echo date("d-m-Y", strtotime($tgl2)); ?> </b></p>
    <br>
    <table class="laporan">
        <thead>
            <tr>
                ...
                <th class="text-center">Pertimbangan</th>
        ...
        <tbody>
            ...
            foreach ($q->result() as $row) {
                echo "<tr id=data href='" . $row->no_sprint . "' tanggal='" . date("Y/m/d", strtotime($row->tanggal)) . "' asal_surat='" . $row->asal_surat . "' tmt='" . date("Y/m/d", strtotime($row->tmt)) . "' perihal='" . $row->perihal . "' ket='" . $row->ket . "' pertimbangan='" . $row->pertimbangan . "' dasar='" . $row->dasar . "' kepada='" . $row->kepada . "' untuk='" . $row->untuk . "' tembusan='" . $row->tembusan . "'>";
                ...
                echo "<td class='text-center'>" . $row->pertimbangan . "</td>";
                echo "<td class='text-center'>" . $row->dasar . "</td>";
                echo "<td class='text-center'>" . $row->kepada . "</td>";
                echo "<td class='text-center'>" . $row->untuk . "</td>";
                echo "<td class='text-center'>" . $row->tembusan . "</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
