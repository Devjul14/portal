<script>
    ...
    $(document).ready(function(e) {
        ...
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('suket/cetaklistmou') ?>/" + tgl1 + "/" + tgl2;
        ...
        $(".add").click(function() {
            window.location = "<?php echo site_url('suket/addmou/') ?>";
            return false;
        });
        $(".edit").click(function() {
            var id = $(".bg-gray").attr("no_surat");
            window.location = "<?php echo site_url('suket/addmou') ?>/" + id;
            return false;
        });
        ...
        $(".reset").click(function() {
            var url = "<?php echo site_url('suket/resetmou'); ?>";
            window.location = url;
        });
    });
    ...
    function pencarian() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('suket/getcarino_mou'); ?>",
            success: function(result) {
                window.location = "<?php echo site_url('suket/listmou'); ?>";
            },
    ...
    <div class="box box-primary">
        <div class="box-body">
            <table class="table table-bordered table-hover " id="myTable">
                <thead>
                    <tr class="bg-navy">
                        <th width="15%" class='text-center'>Tanggal Awal</th>
                ...
                <tbody>
                    ...
                    foreach ($q3->result() as $row) {
                        echo "<tr id=data no_surat='" . $row->no_surat . "' tanggal='" . date("d/m/Y", strtotime($row->tanggal)) . "' tgl_awal='" . date("d/m/Y", strtotime($row->tgl_awal)) . "' tgl_akhir='" . date("d/m/Y", strtotime($row->tgl_akhir)) . "' kepada='" . $row->kepada . "' asal_surat='" . $row->asal_surat . "' perihal='" . $perihal . "' ket='" . $ket . "'>";
...
<div class='modal modalrekap no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Rekap MOU</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
