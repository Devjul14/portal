<script>
    ...
    $(document).ready(function(e) {
        ...
        $(".cetaklistjiwa").click(function() {
            var tgl1 = $("[name='list_tgl1']").val();
            var tgl2 = $("[name='list_tgl2']").val();
            var url = "<?php echo site_url('suket/cetaklistjiwa') ?>/" + tgl1 + "/" + tgl2;
            openCenteredWindow(url);
            return false;
        });
        $(".listjiwa").click(function() {
            $(".modallistjiwa").modal("show");
            return false;
        });
        ...
        $(".reset").click(function() {
            window.location = "<?php echo site_url('suket/reset_jiwa'); ?>/";
            return false;
        });
        $(".detailnarkoba").click(function() {
            ...
            var url = "<?php echo site_url('suket/detailjiwa') ?>/" + no_rm + "/" + no_reg + "/" + jenis;
            window.location = url;
            return false;
        });
    ...
    <div class="box box-primary">
        ...
        <div class="box-footer">
            <div class="row">
                <div class="col-xs-12">
                    <div class="pull-right">
                        <button class="listjiwa btn btn-sm btn-primary" type="button"><i class="fa  fa-file"></i> Rekap</button>
...
<div class='modal modallistjiwa no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Rekap Surat Keterangan Sehat Jiwa</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
            ...
            <div class='modal-footer'>
                <div class="pull-right">
                    <button class="cetaklistjiwa btn btn-success">Cetak</button>
                </div>
            </div>
        </div>
    </div>
