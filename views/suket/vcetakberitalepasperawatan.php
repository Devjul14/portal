...
<body class="page">
    ...
    <table class="table no-border laporan" align="center">
        <tr>
            <td colspan="2" style="vertical-align:middle">
                <h5 align="center"><b><u>BERITA LEPAS PERAWATAN</u></b></h5>
            </td>
        </tr>
        <tr>
            <?php $bulan = array("", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"); ?>
            <td width="50%" align="right">No.<span style="float:right">:</span></td>
            <td><?php echo $p->nomor_surat ?>/ BLP/ <?php echo $bulan[(int)(date("m", strtotime($pi->tgl_keluar)))] . "/ " . date("Y", strtotime($pi->tgl_keluar)); ?></td>
        </tr>
        <tr>
            <td align="right">Kepada :</span></td>
    ...
    <p style="font-size:12px">Telah lepas perawatan di Rumah sakit Tk. III 03.06.01 Ciremai pada </p>
    <table class="table no-border laporan">
        <tr>
            <td>Tanggal<span style="float:right">:</span></td>
            <td><?php echo date("d-m-Y", strtotime($pi->tgl_keluar)); ?> <span class="pull-right">Jam <?php echo date("H:i", strtotime($pi->jam_keluar)); ?></span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Diagnosa Utama<span style="float:right">:</span></td>
            <td><?php echo $rp->row()->diagnosa_akhir; ?></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td align="center">
                Cirebon, Tgl <?php echo date("d-m-Y", strtotime($pi->tgl_keluar)); ?>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td align="center">
                ...
                <b>A.n Rumkit Ciremai Denkesyah Cirebon</b><br>
                <b>Dokter</b><br>
                <span class="ttd_dokter"></span><br>
                <?php echo $pi->nama_dpjp; ?><br>
                SIP : <?php echo $pi->no_sip_dpjp; ?>
            </td>
        </tr>
    </table>
</body>
