...
<body class="page">
    ...
    <p align="center"><b>REKAP RUJUKAN PASIEN</b></p>
    ...
    <table class="laporan">
        <thead>
            <tr>
                ...
                <th style="vertical-align:middle" class='text-center'>Di Kirim Ke RS</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            foreach ($q as $key => $row) {
                ...
                echo "<td class='text-center'>" . substr($row->dikirim, 0, 45) . "</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
