...
<p><b>BUKU KEMATIAN TAHUN <?php echo date("Y",strtotime($tgl1));?></p>
<br>
<table class="laporan">
    <thead>
        <tr>
            ...
            <th style="vertical-align:middle" class='text-center'>Golongan Pasien</th>
            <th style="vertical-align:middle" class='text-center'>Ruangan</th>
            <th style="vertical-align:middle" class='text-center'>Alamat</th>
            <th style="vertical-align:middle" class='text-center'>Tgl Meninggal</th>
            <th style="vertical-align:middle" class='text-center'>Jam</th>
            <th style="vertical-align:middle" class='text-center'>Diagnosa</th>
    ...
    <?php
        ...
        foreach ($q as $key => $row) {
            ...
            echo "<td align='center'>".date("d-m-Y",strtotime($row->tgl_keluar))."</td>";
            echo "<td align='center'>".date("H:i",strtotime($row->jam_keluar))."</td>";
            echo "<td>&nbsp;</td>";
