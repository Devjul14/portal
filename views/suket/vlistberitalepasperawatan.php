<script>
    ...
    $(document).ready(function(e) {
        ...
        $(".cetaklistkelahiran").click(function() {
            ...
            var url = "<?php echo site_url('suket/cetaklistberitalepasperawatan') ?>/" + tgl1 + "/" + tgl2;
            openCenteredWindow(url);
            return false;
        });
        $(".cetakberitalepas").click(function() {
        ...
        $(".reset").click(function() {
            window.location = "<?php echo site_url('suket/reset_berita_lepas_perawatan'); ?>/";
            return false;
        });
                ...
                <tbody>
                    ...
                    foreach ($q3["surat"] as $key => $row) {
                          ...
                          if ($data->nama_pasien!=""){
                            ...
                            $nomor_surat = $row->nomor_surat . "/ BLP/ " . $bulan[(int)(date("m", strtotime($data->tgl_keluar)))] . "/ " . date("Y", strtotime($data->tgl_keluar));
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="pull-right">
                        ...
                        <button class="cetakberitalepas btn btn-sm btn-info" type="button"><i class="fa  fa-print"></i> Cetak</button>
                        <button class="ringkasan btn btn-sm btn-success" type="button"><i class="fa  fa-search-plus"></i> Detail</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class='modal modallistkelahiran no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Cetak Surat Lepas Perawatan</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
