...
<body class="page">
    ...
    <p align="center"><b>REKAP CUTI TAHUNAN</b></p>
    ...
    <table class="laporan">
        ...
        <tbody>
            ...
            foreach ($q->result() as $row) {
                ...
                $umur = $year_diff;
                echo "<tr id=data href='" . $row->nomor . "' tgl_berangkat='" . date("Y/m/d", strtotime($row->tgl_berangkat)) . "' tgl_kembali='" . date("Y/m/d", strtotime($row->tgl_kembali)) . "' nomor='" . $nomor . "' lampiran='" . $lampiran . "' pengirim='" . $row->pengirim . "' perihal='" . $row->perihal . "' disposisi='" . $row->disposisi . "'>";
                ...
                echo "<td class='text-center'>" . ($row->tgl_berangkat == "" ? "" : date("d-m-Y", strtotime($row->tgl_berangkat))) . "</td>";
                echo "<td class='text-center'>" . ($row->tgl_kembali == "" ? "" : date("d-m-Y", strtotime($row->tgl_kembali))) . "</td>";
