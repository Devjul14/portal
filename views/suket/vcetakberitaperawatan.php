...
<body class="page">
    ...
    <table class="table no-border laporan" align="center">
        <tr>
            <td colspan="2" style="vertical-align:middle">
                <h5 align="center"><b><u>BERITA MASUK PERAWATAN</u></b></h5>
            </td>
        </tr>
        <tr>
    ...
    <table class="table no-border laporan">
        <tr>
            ...
            <td><?php echo date("d-m-Y", strtotime($pi->tgl_keluar)); ?> <span class="pull-right">Jam <?php echo date("H:i", strtotime($pi->jam_masuk)); ?></span></td>
        </tr>
        <tr>
