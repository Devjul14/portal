<script>
    function pencarian() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('suket/getcarino_kontrak'); ?>",
            success: function(result) {
                window.location = "<?php echo site_url('suket/list_kontrak'); ?>";
            },
    ...
    $(document).ready(function(e) {
        ...
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('suket/cetaklist_kontrak') ?>/" + tgl1 + "/" + tgl2;
        ...
        $(".add").click(function() {
            window.location = "<?php echo site_url('suket/add_kontrak/') ?>";
            return false;
        });
        $(".edit").click(function() {
            var id = $(".bg-gray").attr("no_surat");
            window.location = "<?php echo site_url('suket/add_kontrak') ?>/" + id;
            return false;
        });
        ...
        $(".reset").click(function() {
            var url = "<?php echo site_url('suket/reset_kontrak'); ?>";
            window.location = url;
        });
    });
            ...
            <table class="table table-bordered table-hover " id="myTable">
                ...
                <tbody>
                    ...
                    foreach ($q3->result() as $row) {
                        ...
                        $no_surat = $row->no_surat . " / " . $bulan[(int)(date("m", strtotime($row->tanggal)))] . "/ " . date("Y", strtotime($row->tanggal));
...
<div class='modal modalrekap no-print' role="dialog">
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class="modal-header bg-orange">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class='modal-title'><i class="icon fa fa-warning"></i>&nbsp;&nbsp;Rekap SP-Keluar</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-sm-12">
