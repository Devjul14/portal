...
if ($row) {
    ...
    $tgl_kep   = $row->tgl_kep != "" ? date("d-m-Y", strtotime($row->tgl_kep)) : "";
        ...
        <div class="box-body">
            <div class="col-md-6">
                <div class="form-horizontal">
                    <?php echo form_open_multipart("suket/simpan_nokep/" . $action, array("id" => "formsave", "class" => "form-horizontal"));
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Tanggal Kep</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" required autocomplete="off" name="tgl_kep" value="<?php echo $tgl_kep; ?>">
                        </div>
                    </div>
                    <div class="form-group">
