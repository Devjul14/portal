...
<body class="page">
    ...
    <p align="center"><b>REKAP SURAT B KELUAR SEKRETARIAT</b></p>
    ...
    <table class="laporan">
        ...
        <tbody>
            ...
            foreach ($q->result() as $row) {
                ...
                $umur = $year_diff;
                echo "<tr id=data href='" . $row->no_b_keluar . "' tanggal='" . date("Y/m/d", strtotime($row->tanggal)) . "' kepada='" . $row->kepada . "' asal_surat='" . $row->asal_surat . "' perihal='" . $row->perihal . "' lampiran='" . $row->lampiran . "'>";
