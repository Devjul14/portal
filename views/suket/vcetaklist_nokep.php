...
<body class="page">
    ...
    <p align="center"><b>REKAP NO KEP</b></p>
    ...
    <table class="laporan">
        <thead>
            <tr>
                ...
                <th width="10%" class='text-center'>Tanggal Kep</th>
        ...
        <tbody>
            ...
            foreach ($q->result() as $row) {
                echo "<tr id=data href='" . $row->no_surat . "' tanggal='" . date("Y/m/d", strtotime($row->tanggal)) . "' tgl_kep='" . date("Y/m/d", strtotime($row->tgl_kep)) . "' asal_surat='" . $row->asal_surat . "' ket='" . $row->ket . "' uraian='" . $row->uraian . "'>";
