...
<body class="page">
    ...
    <p align="center"><b>REKAP LAMPIRAN SPRINT</b></p>
    <br>
    <table class="laporan">
        <thead>
            <tr>
                ...
                <th style="vertical-align:middle" class='text-center'>Jabatan Lama</th>
                <th style="vertical-align:middle" class='text-center'>Jabatan Baru</th>
                <th style="vertical-align:middle" class='text-center'>TMT</th>
                <th style="vertical-align:middle" class='text-center'>Ket</th>
            </tr>
        </thead>
        <tbody>
            <?php
            foreach ($p1->result() as $key => $row) {
                ...
                echo "<td align='text-center'>" . date("d-m-Y", strtotime($row->ta_tmt)) . "</td>";
                echo "<td class='text-center'>" . substr($row->keterangan, 0, 45) . "</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
