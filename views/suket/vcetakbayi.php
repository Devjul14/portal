...
<table class="table no-border">
    <tr>
        <td width="30%">Nama<span class='pull-right'>:</span></td>
        <td> <?php echo $q1->nama_dokter ?></td>
    </tr>
    <tr>
        <td>Jabatan<span class='pull-right'>:</span></td>
        <td> <?php echo $q1->jenis_kelompok ?> <?php echo $q1->nama_kelompok ?></td>
    </tr>
    <tr>
        <td>SIP<span class='pull-right'>:</span></td>
        <td> <?php echo $q1->no_sip ?></td>
    </tr>
    <tr>
        <td>Alamat<span class='pull-right'>:</span></td>
        <td> <?php echo $q3->alamat_rs ?></td>
    </tr>
</table>
<br>
...
<table class="table no-border">
    ...
    <tr>
        <td>No RM<span class='pull-right'>:</span></td>
        <td> <?php echo $no_pasien ?></td>
    </tr>
    <tr>
        <td>Umur<span class='pull-right'>:</span></td>
        <td> <?php echo $umur_thn ?> Tahun</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Alamat Rumah<span class='pull-right'>:</span></td>
