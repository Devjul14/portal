...
var mywindow;
    ...
    $(document).ready(function(){
		...
		$(".edit").click(function(){
            var id = $(this).val();
			window.location = "<?php echo site_url('persalinan/catatan_persalinan')?>/"+id;
            return false;
        });
...
<div class="col-xs-12">
	...
	<?php echo form_open("persalinan",array("id"=>"formcari"));?>
	<div class="box box-primary">
		<div class="box-body">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="control-label col-xs-2">Halaman ke</label>
					<div class="col-xs-5">
		...
		<div class="box-body">
			<table id="myTable" class="table table-bordered">
				<thead>
					<tr class="bg-navy">
						<th width="49px">No</th>
						<th width="120px">Tgl Persalinan</th>
						<th width="100px">No. Pasien</th>
						<th>Nama</th>
						<th width="100px">&nbsp;</th>
					</tr>
				</thead>
					...
					<?php
						...
						foreach ($q->result() as $row){
							...
							echo "<tr id=data>
								  ...
								  <td class=text-center>".date('d-m-Y',strtotime($row->tgl_persalinan))."</td>
								  <td class=text-center>".$row->no_pasien."</td>
								  <td>".$row->nama_pasien."</td>
								  <td class=text-center>
										<button type='button' class='edit btn btn-success btn-sm' value='".$row->id_pendaftaran."/".$row->id_bumil."'><i class='fa fa-edit'></i></button>
										<button type='button' class='hapus btn btn-danger btn-sm' value='".$row->id_bumil."'><i class='fa fa-remove'></i></button>
								  </td>
							</tr>";
						}
					?>
