...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            var cari_satuan = $("input[name='cari_satuan']").val();
            $.ajax({
                url: "<?php echo site_url('farmasi/cari_satuan');?>", 
                type: 'POST', 
                data: {cari_satuan: cari_satuan}, 
                success: function(){
                    location.reload();
                }
            });
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formsatuan')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formsatuan')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapussatuan')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('farmasi/reset_satuan');?>/";
            return false;
        });
        ...
        <div class="box-footer"> 
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="cari_satuan" value="<?php echo $this->session->userdata("cari_satuan") ?>" autocomplete="off"/>
                    </div>
                    <div class="col-md-1">
                        <div class="pull-left">
