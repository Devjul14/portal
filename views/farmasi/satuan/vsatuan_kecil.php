...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            ...
            $.ajax({
                url: "<?php echo site_url('farmasi/cari_satuankecil');?>", 
                type: 'POST', 
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formsatuan_kecil')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formsatuan_kecil')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapussatuan_kecil')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('farmasi/reset_satuankecil');?>/";
            return false;
        });
