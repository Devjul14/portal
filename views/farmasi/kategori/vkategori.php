...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            ...
            $.ajax({
                url: "<?php echo site_url('farmasi/cari_kategori');?>", 
                type: 'POST', 
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formkategori')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formkategori')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapuskategori')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('farmasi/reset_kategori');?>/";
            return false;
        });
