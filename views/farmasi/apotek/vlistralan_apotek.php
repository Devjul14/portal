...
var mywindow;
    ...
    $(document).ready(function(e){
        $(".laporan_harian").click(function(){
            ...
            var url = "<?php echo site_url('apotek_farmasi/laporanharian_ralan');?>";
            window.location = url;
            return false;
        });
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('apotek_farmasi/search_ralan');?>",
                type: 'POST',
                data: arrayData,
                success: function(){
                    location.reload();
        ...
        $(".reset").click(function(){
            var url = "<?php echo site_url('apotek_farmasi/reset_ralan');?>";
            window.location = url;
            return false;
        });
        $(".pdf").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek_farmasi/formuploadpdf');?>/ralan/"+id;
            window.location = url;
            return false;
        });
        ...
        $(".terima1").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('apotek_farmasi/terima_ralan')?>/"+id;
            return false;
        });
        $(".obat").click(function(){
            var id = $(".bg-gray").attr("href");
            ...
            if (phone==""){
                ...
                openCenteredWindow(url);
                window.location = "<?php echo site_url('apotek_farmasi/obat_ralan')?>/"+id;
                return false;
            }
        });
        $(".respond").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek_farmasi/respond_ralan')?>/"+id;
            openCenteredWindow(url);
        });
    });
</script>
