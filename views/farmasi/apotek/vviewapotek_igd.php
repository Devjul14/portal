...
var mywindow;
 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        //     var obat= $(this).val();
        //     $.ajax({
        //         url : "<?php echo base_url();?>apotek_farmasi/addobat",
        //         method : "POST",
        ...
        // });
        // $('.back').click(function(){
        //     window.location = "<?php echo site_url('apotek_farmasi/list_igd');?>";
        // });
        ...
        $('.back').click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('apotek_farmasi/getcaripasien_igd');?>",
        ...
        $('.print').click(function(){
            ...
            var no_reg= $("[name='no_reg']").val();
            var url = "<?php echo site_url('apotek_farmasi/cetak');?>/"+no_rm+"/"+no_reg;
            openCenteredWindow(url);
        });
        $('.hapus').click(function(){
            var id= $(this).attr("id");
            $.ajax({
                url : "<?php echo base_url();?>apotek_farmasi/hapusobat",
                method : "POST",
                data : {id: id},
                success: function(data){
                     location.reload();
        ...
        $('.lunas').click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url();?>apotek_farmasi/simpanobat",
                method : "POST",
    ...
    var changeData = function(value,id,obat){
        $.ajax({
            url: "<?php echo site_url('apotek_farmasi/changedata');?>", 
            type: 'POST', 
    ...
    <div class="box box-primary">
        <div class="box-body">
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        <th width="100px" rowspan="2" class='text-center'>No</th>
                        <th width="400px" rowspan="2" class="text-center">Nama Obat</th>
                        <th width="200px" rowspan="2" class="text-center">Aturan Pakai</th>
                        <th width="200px" rowspan="2" class="text-center">Waktu</th>
                        <th width="200px" rowspan="2" class="text-center">Takaran</th>
                        <th width="500px" colspan="5" class="text-center">Cara</th>
                        <th width="50px" rowspan="2"></th>
                        <th width="150px" rowspan="2" class="text-center">Qty</th>
                        <th width="100px" rowspan="2" class="text-center">Satuan</th>
                        <th width="100px" rowspan="2" class='text-center'>Jumlah</th>
                    </tr>
                    <tr class="bg-navy">
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo form_open("apotek_farmasi/simpanwaktu_ralan",array("id"=>"formsave","class"=>"form-horizontal"));
                ...
                <tfoot>
                    <tr>
                        <th colspan="10" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th><th style="vertical-align: middle" ><input type="text" readonly name="subtotal" class="form-control text-right" value="<?php echo number_format($subtotal,0,',','.');?>"></th></tr>
                    <tr>
                        <th colspan="10" style="vertical-align: middle" ><span class="pull-right">Disc</span></th>
                    ...
                    <tr><th colspan="10" style="vertical-align: middle" ><?php echo $tgl_pembayaran;?><span class="pull-right">Total</span></th><th style="vertical-align: middle" ><input type="text" readonly name="total" class="form-control text-right" value="<?php echo number_format($total,0,',','.');?>"></th></tr>
                </tfoot>
            </table>
        </div>
        <div class="box-footer">
            <div class="col-md-9">
                <?php echo form_open("apotek_farmasi/addobat",array("id"=>"formsave","class"=>"form-horizontal"));?>
