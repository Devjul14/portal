...
<table cellspacing="2" cellpadding="1"  width="100%" align="right">
	...
	<tr>
		<td>Pelayanan </td>
		<td>:&nbsp;<?php echo $q->poli ?></td>
	</tr>
	<tr>
		<td>Pasien </td>
		<td>:&nbsp;<?php echo $q->nama_pasien ?><span class="pull-right">No RM :&nbsp;<?php echo $q->no_rekmed ?></span></td>
	</tr>
	<tr>
		<td>Status Pasien </td>
	...
	<tbody>
		<?php
	        ...
	        $total += $row->jumlah;
	            ...
	            echo "<td align='right'><span class='pull-left'>Rp.</span>".number_format($jumlah,0,',','.')."</td>";
	            echo "<td align='right'><span class='pull-left'>Rp.</span>".number_format($row->jumlah,0,',','.')."</td>";
	            echo "</tr>";
	        $i++;
	    }
	    ?>
...
<table width="100%" border="0" rules="rows">
		<tr>
			...
			<th align="right"><span class="pull-left">Rp.</span><?php echo number_format($total,0,',','.'); ?></th>
		</tr>
	</table>
