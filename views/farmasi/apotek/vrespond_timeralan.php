		...
		<td><table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr>
                        ...
                        <th >Nama</th>
                        <th class='text-center'>Jam Obat</th>
                        <th class='text-center'>Jam Terima</th>
                ...
                <tbody>
                    <?php
						...
						$t1 = new DateTime($data->tanggal_obatapotek);
						$t2 = new DateTime($data->tanggal_terimaapotek);
						...
						$s  = $t1->diff($t2)->s;
                        	...
                        	echo "<td>".date("H:i:s",strtotime($data->tanggal_obatapotek))."</td>";
                        	echo "<td>".date("H:i:s",strtotime($data->tanggal_terimaapotek))."</td>";
