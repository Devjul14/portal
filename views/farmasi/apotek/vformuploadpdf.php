...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo form_open_multipart("apotek_farmasi/uploadpdf/".$jenis,array("id"=>"formsave","class"=>"form-horizontal")) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="file" name="pdfapotek" accept="application/pdf,application/jpg">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach($q->result() as $val){
                                ...
                                echo "<td>".$i."</td>";
                                echo "<td><a href='".base_url()."file_pdf/".$jenis."/".$val->file_pdf."' target='blank'>".$val->file_pdf."</a></td>";
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
