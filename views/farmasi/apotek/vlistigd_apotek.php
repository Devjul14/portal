...
var mywindow;
    ...
    $(document).ready(function(e){
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('apotek_farmasi/search_igd');?>",
                type: 'POST',
                data: arrayData,
                success: function(){
                    location.reload();
        ...
        $(".pdf").click(function(){
            ...
            var url = "<?php echo site_url('apotek_farmasi/formuploadpdf');?>/igd/"+id;
            window.location = url;
            return false;
        });
        $(".reset").click(function(){
            var url = "<?php echo site_url('apotek_farmasi/reset_igd');?>";
            window.location = url;
            return false;
        });
        ...
        $(".view").click(function(){
            ...
            if (igd=="1"){
                var url = "<?php echo site_url('apotek_farmasi/viewapotek_igd');?>/"+id;
            } else {
                var url = "<?php echo site_url('apotek_farmasi/viewapotek_ralan');?>/"+id;
            }
            window.location = url;
            return false;
        });
        $(".laporan_harian").click(function(){
            var url = "<?php echo site_url('apotek_farmasi/laporanharian_igd');?>";
            window.location = url;
            return false;
        });
        ...
        $(".terima1").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('apotek_farmasi/terima')?>/"+id;
            return false;
        });
        $(".obat").click(function(){
            var id = $(".bg-gray").attr("href");
            ...
            if (phone==""){
                ...
                openCenteredWindow(url);
                window.location = "<?php echo site_url('apotek_farmasi/obat')?>/"+id;
                return false;
            }
        });
        $(".respond").click(function(){
            var id = $(".bg-gray").attr("href");
            var url = "<?php echo site_url('apotek_farmasi/respond')?>/"+id;
            openCenteredWindow(url);
        });
    });
</script>
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        ...
                        $icon_terima = ($row->tanggal_terimaigd==="0000-00-00 00:00:00" ? "<i class='fa fa-edit text-blue'></i>" : "");
                        $icon_obat = ($row->tanggal_obatigd==="0000-00-00 00:00:00" ? "<i class='fa fa-edit text-green'></i>" : "");
