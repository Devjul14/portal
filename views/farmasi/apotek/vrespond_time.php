		...
		<td><table class="table table-bordered table-hover " id="myTable" >
                ...
                <tbody>
                    <?php
						...
						$t1 = new DateTime($data->tanggal_obatigd);
						$t2 = new DateTime($data->tanggal_terimaigd);
						...
						$s  = $t1->diff($t2)->s;
                        	...
                        	echo "<td>".date("H:i:s",strtotime($data->tanggal_obatigd))."</td>";
                        	echo "<td>".date("H:i:s",strtotime($data->tanggal_terimaigd))."</td>";
