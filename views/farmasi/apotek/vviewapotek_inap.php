...
var mywindow;
 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        //     var obat= $(this).val();
        //     $.ajax({
        //         url : "<?php echo base_url();?>apotek_farmasi/addobat_inap",
        //         method : "POST",
        //         data : {no_reg: no_reg, obat: obat, tanggal: tanggal},
        ...
        $('.print').click(function(){
            ...
            var url = "<?php echo site_url('apotek_farmasi/cetak_inap');?>/"+no_rm+"/"+no_reg+"/"+"all"+"/"+tgl1_print+"/"+tgl2_print;
            openCenteredWindow(url);
        });
        $('.hapus').click(function(){
            var id= $(this).attr("id");
            $.ajax({
                url : "<?php echo base_url();?>apotek_farmasi/hapusobat_inap",
                method : "POST",
                data : {id: id},
                success: function(data){
                     location.reload();
        ...
        $('.lunas').click(function(){
            ...
            var tanggal= $("[name='tanggal']").val();
            $.ajax({
                url : "<?php echo base_url();?>apotek_farmasi/simpanobat_inap",
                method : "POST",
        ...
        //     var tanggal= $("[name='tanggal']").val();
        //     $.ajax({
        //         url : "<?php //echo base_url();?>apotek_farmasi/simpanwaktu_inap",
        //         method : "POST",
        //         data : {no_reg: no_reg,disc_nominal: disc_nominal, total: total,tanggal:tanggal},
        //         success: function(data){
        //              location.reload();
    ...
    var changeData = function(value,id,obat){
        $.ajax({
            url: "<?php echo site_url('apotek_farmasi/changedata_inap');?>", 
            type: 'POST', 
    ...
    <div class="box box-primary">
        <div class="box-body">
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                <tbody>
                    <?php
                        ...
                        foreach($k->result() as $data){
                            ...
                            echo form_open("apotek_farmasi/simpanwaktu_inap",array("id"=>"formsave","class"=>"form-horizontal"));
                ...
                <tfoot>
                    <tr><th colspan="14" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th><th style="vertical-align: middle" ><input type="text" readonly name="subtotal" class="form-control text-right" value="<?php echo number_format($subtotal,0,',','.');?>"></th></tr>
                    <tr>
                        <th colspan="14" style="vertical-align: middle" ><span class="pull-right">Disc</span></th>
                    ...
                    <tr><th colspan="14" style="vertical-align: middle" ><?php echo $tgl_pembayaran;?><span class="pull-right">Total</span></th><th style="vertical-align: middle" ><input type="text" readonly name="total" class="form-control text-right" value="<?php echo number_format($total,0,',','.');?>"></th></tr>
                </tfoot>
            </table>
        </div>
        <div class="box-footer">
            ...
            <div class="col-md-6">
                <div class="row">
                    <?php echo form_open("apotek_farmasi/addobat_inap",array("id"=>"formsave","class"=>"form-horizontal"));?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="col-md-12 control-label">Tanggal</label>
                            <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="col-md-12 control-label">Obat</label>
                            <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="col-md-12 control-label">Dokter Pengirim</label>
                            <div class="col-md-12">
