...
var mywindow;
 ...
 var mywindow1;
    ...
    $(document).ready(function(){
        ...
        // });
        // $('.back').click(function(){
        //     window.location = "<?php echo site_url('apotek_farmasi/list_ralan');?>";
        // });
        ...
        $('.back').click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('apotek_farmasi/getcaripasien_ralan');?>",
    ...
    var changeData = function(value,id,obat,change){
        $.ajax({
            url: "<?php echo site_url('apotek_farmasi/changedata');?>/"+change, 
            type: 'POST', 
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th width="150" rowspan="2" class="text-center">Qty</th>
                ...
                <tfoot>
                    <tr><th colspan="10" style="vertical-align: middle" ><span class="pull-right">Subtotal</span></th><th style="vertical-align: middle" colspan="4"><input type="text" readonly name="subtotal" class="form-control text-right" value="<?php echo number_format($subtotal,0,',','.');?>"></th><th colspan="2">&nbsp;</th></tr>
                    <tr>
                    ...
                    <tr><th colspan="10" style="vertical-align: middle" ><?php echo $tgl_pembayaran;?><span class="pull-right">Total</span></th><th style="vertical-align: middle" colspan="4"><input type="text" readonly name="total" class="form-control text-right" value="<?php echo number_format($total,0,',','.');?>"></th><th colspan="2">&nbsp;</th></tr>
                </tfoot>
            </table>
        </div>
