<script>
    ...
    $(document).ready(function(e){
        ...
        $(".print").click(function(){
            ...
            var url = "<?php echo site_url('kasir/cetak_laporan_inap')?>/"+frm+"/"+tgl1+"/"+tgl2+"/"+golpas+"/"+poli;
            openCenteredWindow(url);
        });
        $("input[name='tgl1']").change(function(){
            var tgl1 = $("input[name='tgl1']").val();
            var tgl2 = $("input[name='tgl2']").val();
            window.location = "<?php echo site_url("apotek_farmasi/laporanharian_inap");?>/"+tgl1+"/"+tgl2;
        });
