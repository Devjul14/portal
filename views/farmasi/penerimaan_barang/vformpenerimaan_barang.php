<script>
    $(document).ready(function(){
        ...
        $(".back").click(function(){
            window.location = "<?php echo site_url('penerimaan/penerimaan_barang')?>";
            return false;
        });
        $(".hapus").click(function(){
            var kode= $(this).attr("href");
            window.location = "<?php echo site_url('penerimaan/hapusitemrk')?>/"+kode;
            return false;
        });
        $("select[name='no_pemesanan']").change(function(){
            var kode= $(this).val();
            window.location = "<?php echo site_url('penerimaan/formpenerimaan_barang')?>/"+kode;
            return false;
        });
    });
</script>
...
<div class="col-md-12">
    ...
    <div class="box box-info">
        <?php echo form_open("penerimaan/simpanpenerimaan/".$action,array("id"=>"formsimpan","class"=>"form-horizontal"));?>
        <div class="box-body">
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered" id="data">
                        <tr class="bg-navy">
                            ...
                            <th rowspan="2" width="100px" class="text-center">Total Harga</th>
                        </tr>
                        <tr class="bg-navy">
                            <td>%</td>
                            <td>Rp</td>
                        ...
                        <?php
                            ...
                            foreach ($irk->result() as $value) {
                                if ($value->sisa_pengajuan!=0) {
                                    $jumlah = "<input type='number' class='form-control' name='jumlah_penerimaan[".$value->kode_obat."]' max='".$value->sisa_pengajuan."' value='".$value->sisa_pengajuan."'>";
                                    $batch = "<input type='text' class='form-control' name='batch[".$value->kode_obat."]'>";
                                    $expire_date = "<input type='text' class='form-control expire_date' name='expire_date[".$value->kode_obat."]'>";
                                    $disc = "<input type='text' class='form-control' name='disc[".$value->kode_obat."]' placeholder='%' value='0'>";
                                    $disc_rupiah = "<input type='number' class='form-control' name='disc_rupiah[".$value->kode_obat."]' value='0'>";
                                    $harga = "<input type='number' class='form-control' name='harga[".$value->kode_obat."]' value='".$value->harga."'>";
                                } else {
                                    $harga = 
                                    $jumlah = 
                                    $batch  = 
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td>
                                            ".$batch."
                                            <input type='hidden' class='form-control' name='jumlah_pemesanan[".$value->kode_obat."]' value='".$value->jumlah."'>
                                        </td>
                                        <td>
                                            ".$expire_date."
                                        </td>
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered" id="data">
                        <tr class="bg-navy">
                            ...
                            <th width="100px" class="text-center">Total Harga</small></th>
                        </tr>
                        <?php
