...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            ...
            $.ajax({
                url: "<?php echo site_url('farmasi/cari_supplier');?>", 
                type: 'POST', 
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formsupplier')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formsupplier')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapussupplier')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('farmasi/reset_supplier');?>/";
            return false;
        });
