...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            ...
            $.ajax({
                url: "<?php echo site_url('permintaan/search_pengajuan');?>", 
                type: 'POST', 
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('permintaan/formpengajuan_depo')?>";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('permintaan/formpengajuan_depo')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('permintaan/hapuspengajuan_depo')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('permintaan/reset_pengajuan');?>/";
            return false;
        });
