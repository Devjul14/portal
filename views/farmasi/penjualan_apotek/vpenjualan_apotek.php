...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(){
            var cari_penjualan  = $("[name='cari_penjualan']").val();
            var tgl1            = $("[name='tgl1']").val();
            var tgl2            = $("[name='tgl2']").val();
            var depo            = $("[name='depo']").val();
            $.ajax({
                url: "<?php echo site_url('penjualan_apotek/search_penjualan');?>", 
                type: 'POST', 
                data: {cari_penjualan: cari_penjualan,tgl1: tgl1, tgl2: tgl2,depo: depo}, 
                success: function(){
                    location.reload();
                }
            });
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('penjualan_apotek/formpenjualan_apotek')?>";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('penjualan_apotek/formpenjualan_apotek')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('penjualan_apotek/hapuspenjualan_apotek')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('penjualan_apotek/reset_penjualan');?>/";
            return false;
        });
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                <thead>
                    <tr class="bg-navy">
                        ...
                        <th width="200" class='text-center'>No Penjualan</th>
                        <th class='text-center'>Keterangan</th>
                        <th width="100" class='text-center'>Pembeli</th>
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        $i++;
                        echo "
                            <tr id=data href='".$row->no_penjualan."'>
                                <td>".$i."</td>
        ...
        <div class="box-footer"> 
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control" name="cari_penjualan" value="<?php echo $this->session->userdata("cari_penjualan") ?>" autocomplete="off"/>
                    </div>
