...
var mywindow;
    ...
    $(document).ready(function(e){
        ...
        $(".search").click(function(event){
            var cari_jenis = $("input[name='cari_jenis']").val();
            $.ajax({
                url: "<?php echo site_url('farmasi/cari_jenis');?>", 
                type: 'POST', 
                data: {cari_jenis: cari_jenis}, 
                success: function(){
                    location.reload();
                }
            });
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formjenis')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formjenis')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapusjenis')?>/"+id;
            return false;
        });
        $(".reset").click(function(){
        	window.location ="<?php echo site_url('farmasi/reset_jenis');?>/";
            return false;
        });
           ...
           <table class="table table-bordered table-hover " id="myTable" >
                ...
                <?php
                    ...
                    foreach ($q3->result() as $row){
                        echo "<tr id=data href='".$row->kode_jenis."'>";
        ...
        <div class="box-footer"> 
            <div class="form-horizontal">
                <div class="form-group">
                    <label class="col-md-2 control-label">Cari Jenis</label>

                    <div class="col-md-4">
                        <input type="text" class="form-control" name="cari_jenis" value="<?php echo $this->session->userdata("cari_jenis") ?>" autocomplete="off"/>
                    </div>
                    <div class="col-md-1">
                        <div class="pull-left">
