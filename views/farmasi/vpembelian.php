...
var mywindow;
    ...
    function pencarian(){
        ...
        var tgl1 = $("[name='tgl2']").val();
        var tgl2 = $("[name='tgl2']").val();
        $.ajax({
            type  : "POST",
            data  : {tgl1:tgl1,tgl2:tgl2,cari_nama:cari_nama},
            url   : "<?php echo site_url('apotek/search');?>",
    ...
    $(document).ready(function(e){
        ...
        $(".tambah").click(function(){
            window.location = "<?php echo site_url('farmasi/formpembelian')?>/";
            return false;
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/formpembelian')?>/"+id;
            return false;
        });

        $(".hapus").click(function(){
            var id = $(".bg-gray").attr("href");
            window.location = "<?php echo site_url('farmasi/hapuspembelian')?>/"+id;
            return false;
        });
        $(".view").click(function(){
            var id = $(".bg-gray").attr("href");
            ...
            <table class="table table-bordered table-hover " id="myTable" >
                ...
                $i=1;
                    foreach ($q3->result() as $row){
                        ...
                        echo "<td>".$row->kode_kas."</td>";
                        // echo "<td>".$row->alamat."</td>";
                        echo "<td>".$row->hutang."</td>";
        ...
        <div class="box-footer"> 
            <div class="form-horizontal">
                <div class="form-group">
                   <label class="col-md-1 control-label">Supplier</label>
                    <div class="col-md-4">
                            <input type="text" class="form-control" name="cari_nama" value="<?php echo $this->session->userdata("cari_nama") ?>" autocomplete="off"/>
                    </div>  
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <button class="edit btn btn-warning" type="button"><i class="fa fa-edit"></i> View Pembelian</button>
