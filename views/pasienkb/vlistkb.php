...
var mywindow;
    ...
    $(document).ready(function(){
		...
		$(".edit").click(function(){
            var id = $(this).val();
			window.location = "<?php echo site_url('pasienkb/pasienkbdetail')?>/"+id;
            return false;
        });
...
<div class="col-xs-12">
	...
	<?php echo form_open("pasienkb/listkb",array("id"=>"formcari"));?>
		...
		<div class="box-body">
			<table id="myTable" class="table table-bordered">
				<thead>
					<tr class="bg-navy">
					   <th width="49px">No</th>
					   <th width="120px" class="text-center">Tgl Daftar</th>
