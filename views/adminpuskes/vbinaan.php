...
<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('adminpuskes/formbinaan');?>";
            window.location = url;
            // alert(url);
            return false; 
        });
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('adminpuskes/formbinaan');?>/"+id;
            window.location = url;
            // alert(url);
            return false; 
        });
        $(".hapus").click(function(){
            var id = $(".seleksi").attr("href");
            var url = "<?php echo site_url('adminpuskes/hapusbinaan');?>/"+id;
            window.location = url;
            return false; 
        });
    });
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Nama SD</th>
                        ...
                        <?php
                            if ($q1->num_rows()<=0){
                                ...
                                foreach($q1->result() as $row){
                                    echo "<tr id=data href='".$row->id_sd."'>";
