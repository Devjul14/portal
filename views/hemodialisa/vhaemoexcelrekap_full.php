...
header("Content-Disposition: attachment; filename=Rekap_Haemodialisa_".date('YmdHis').".xls");
...
<link rel="stylesheet" href="<?php echo base_url();?>css/print.css">
    <h4 style="margin-left: 250px; width: 25cm;" align="center">LAPORAN PEMERIKSAAN HAEMODIALISA RAWAT JALAN DAN RAWAT INAP <br>
