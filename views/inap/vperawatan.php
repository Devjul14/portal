...
<script>
    ...
    $(document).ready(function() {
        ...
        $("input[name='tgl']").datepicker({ format : formattgl });
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width="200" class="text-center">Tgl</th>
                        ...
                        <?php  
                            ...
                            foreach ($q2->result() as $data) {
                                ...
                                echo "<tr id=data >
                                        ...
                                        <td>".$this->tglindo->tgl($data->tgl,2)."</td>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <div class="form-horizontal">
                    ...
                    <?php echo form_open("inap/simpanperawatan",array("class"=>"form-horizontal"));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="hidden" name="id_pendaftaran" class="form-control" value="<?=$id?>">
                            ...
                            <select name="tindakan" class="form-control">
                                ...
                                <?php  
                                    ...
                                    foreach ($q1->result() as $t) {

                                        echo "

                                            <option value='".$t->id_tindakan."'>".$t->nama_tindakan." (".number_format($t->karcis).")</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="text" name="tgl" class="form-control" value="<?=date('d-m-Y')?>">
