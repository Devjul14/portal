<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('tarif/form_radiologi');?>";
            window.location = url;
            return false; 
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");;
            var url = "<?php echo site_url('tarif/form_radiologi');?>/"+id;
            window.location = url;
            return false; 
        });
    });
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    <thead>
                        <tr class="bg-navy">
                            ...
                            <th class="text-center">Isolasi</th>
                    ...
                    <tbody>
                        <?php 
                            ...
                            foreach ($q->result() as $data) {
                                $i++;
                                echo "<tr id=data href='".$data->id_tindakan."'>
                                        <td>".$i."</td>
                                        ...
                                        <td>".number_format($data->vip, 0, ",", ".")."</td>
                                        <td>".number_format($data->kelas_1, 0, ",", ".")."</td>
                                        <td>".number_format($data->kelas_2, 0, ",", ".")."</td>
                                        <td>".number_format($data->kelas_3, 0, ",", ".")."</td>
                                        <td>".number_format($data->isolasi, 0, ",", ".")."</td>
