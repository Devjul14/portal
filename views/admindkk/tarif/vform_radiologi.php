...
<script>
    $(document).ready(function() {
        $(".back").click(function(){
            var url = "<?php echo site_url('tarif/tarif_radiologi');?>";
            window.location = url;
            return false; 
        });
    });
...
?>
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo form_open("tarif/simpan_tarifradiologi/".$aksi,array("class"=>"form-horizontal"));?>
                <div class="form-group">
                   <label class="col-sm-2 control-label">Kode</label>
                   <div class="col-sm-10">
                        <input type="text" name="id_tindakan" class="form-control" autocomplete="off" value="<?=$id_tindakan;?>"  <?php echo $r ?>>
                    </div>
                </div>
                <div class="form-group">
