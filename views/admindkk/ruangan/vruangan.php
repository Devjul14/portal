<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('ruangan/formruangan');?>";
        ...
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('ruangan/formruangan');?>/"+id;
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('ruangan/hapusruangan');?>/"+id;
            return false;
        });
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    ...
                    <thead>
                        ...
                        <tr class="bg-navy">
                            ...
                            <th width="50">No</th>
                            <th width="150" class="text-center">Kode Ruangan</th>
                    ...
                    <tbody>
                        ...
                        <?php  
                            ...
                            foreach ($q->result() as $data) {
                                ...
                                echo "<tr id=data href='".$data->kode_ruangan."'>
