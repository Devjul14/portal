<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('poliklinik/formpoliklinik');?>";
            window.location = url;
            // alert(url);
            return false; 
        });
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('poliklinik/formpoliklinik');?>/"+id;
            window.location = url;
            // alert(url);
            return false; 
        });
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('poliklinik/hapuspoliklinik');?>/"+id;
            return false;
        });
    });
</script>
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover" id="myTable">
                   <thead>
                       <tr class="bg-navy">
                            <th width="50">No</th>
                            <th width="200" class="text-center">Kode</th>
                            <th class="text-center">Nama</th>
                            <th class="text-center">Kode Briging</th>
