<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('user/formstatus_user');?>";
            window.location = url;
            return false; 
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");;
            var url = "<?php echo site_url('user/formstatus_user');?>/"+id;
            window.location = url;
            return false; 
        });
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('user/hapusstatus_user');?>/"+id;
            return false;
        });
    });
</script>
        ...
        <div class="box-body">
            <table class="table table-bordered table-hover" id="myTable">
                <thead>
                    <tr class="bg-navy">
                        <th width="50">No</th>
                        <th width="150" class="text-center">Id Status</th>
                        <th class="text-center">Status User</th>
                        <th width="150" class="text-center">Controller</th>
                   </tr>
               </thead>
               <tbody>
                   <?php  
