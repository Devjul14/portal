<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('user/formuser_login');?>";
            window.location = url;
            // alert(url);
            return false; 
        });
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('user/formuser_login');?>/"+id;
            window.location = url;
            // alert(url);
            return false; 
        });
       ...
       $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('user/hapususer_login');?>/"+id;
           return false;
       });
    });
</script>
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover" id="myTable">
                    <thead>
                        <tr class="bg-navy">
                            <th width="50">No</th>
                            <th width="200" class="text-center">Nip</th>
