<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('dokter/formgelar_depan');?>";
        ...
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('dokter/formgelar_depan');?>/"+id;
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('dokter/hapusgelar_depan');?>/"+id;
            return false;
        });
