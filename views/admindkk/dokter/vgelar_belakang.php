<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('dokter/formgelar_belakang');?>";
        ...
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('dokter/formgelar_belakang');?>/"+id;
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('dokter/hapusgelar_belakang');?>/"+id;
            return false;
        });
                    ...
                    <tbody>
                        ...
                        <?php  
                            ...
                            foreach ($q->result() as $data) {
                                ...
                                echo "<tr id=data href='".$data->id_gelar."'>
