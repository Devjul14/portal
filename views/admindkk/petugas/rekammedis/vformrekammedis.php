...
<script>
    $(document).ready(function() {
        ...
        $(".back").click(function(){
            var url = "<?php echo site_url('petugas/rekammedis');?>";
            window.location = url;
            return false; 
        });
    ...
    function getimage(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>/petugas/getttdrm", 
            type: 'POST', 
            data: {nip:nip},
    ...
    function getphoto(){
        var nip = $("[name='nip']").val();
        $.ajax({
            url: "<?php echo base_url();?>/petugas/getphoto", 
            type: 'POST', 
            data: {nip:nip},
            success: function(imgdata){
                image = (imgdata=="") ? "<?php echo base_url();?>img/default-image_450.png" : 'data:image/gif;base64,'+imgdata;
...
<div class="col-xs-12">
    <div class="box box-primary">
        <div class="box-body">
            <?php echo form_open_multipart("petugas/simpanrekammedis/".$aksi,array("class"=>"form-horizontal"));?>
