<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('petugas/formrekammedis');?>";
            window.location = url;
            return false; 
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");;
            var url = "<?php echo site_url('petugas/formrekammedis');?>/"+id;
            window.location = url;
            return false; 
        });
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('petugas/hapusrekammedis');?>/"+id;
            return false;
        });
    });
</script>
