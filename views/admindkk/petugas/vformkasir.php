...
<script>
    $(document).ready(function() {
        ...
        $(".back").click(function(){
            var url = "<?php echo site_url('petugas/kasir');?>";
            window.location = url;
            return false; 
        });
    ...
    function getimage(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>/petugas/getttd", 
            type: 'POST', 
            data: {nip:nip},
...
<div class="col-xs-12">
    <div class="box box-primary">
        <div class="box-body">
            <?php echo form_open_multipart("petugas/simpankasir/".$aksi,array("class"=>"form-horizontal"));?>
