...
<script>
    $(document).ready(function() {
        $(".back").click(function(){
            var url = "<?php echo site_url('admindkk/golpasien');?>";
            window.location = url;
            return false; 
        });
    });
...
?>
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo form_open("admindkk/simpangolpasien/".$action,array("class"=>"form-horizontal"));?>               
               <input type="text" name="id_gol" hidden value="<?=$id_gol;?>">
