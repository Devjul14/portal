<script>
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            var url = "<?php echo site_url('admindkk/formujifungsi');?>";
            window.location = url;
            return false; 
        });
        $(".edit").click(function(){
            var id = $(".bg-gray").attr("href");;
            var url = "<?php echo site_url('admindkk/formujifungsi');?>/"+id;
            window.location = url;
            return false; 
        });
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('admindkk/hapusujifungsi');?>/"+id;
            return false;
        });
    });
</script>
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    <thead>
                        <tr class="bg-navy">
                            ...
                            <th style="vertical-align:middle" class="text-center">Koding</th>
                            <th style="vertical-align:middle" class="text-center">Diagnosa Fungsional</th>
                            <th style="vertical-align:middle" class="text-center">Diagnosa Medis</th>
                            <th style="vertical-align:middle" class="text-center">Hasil</th>
                            <th style="vertical-align:middle" class="text-center">Kesimpulan</th>
                            <th style="vertical-align:middle" class="text-center">Rekomendasi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php  
