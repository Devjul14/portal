<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('admindkk/formpangkat');?>";
        ...
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('admindkk/formpangkat');?>/"+id;
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('admindkk/hapuspangkat');?>/"+id;
            return false;
        });
                    ...
                    <tbody>
                        ...
                        <?php  
                            ...
                            foreach ($q->result() as $data) {
                                ...
                                echo "<tr id=data href='".$data->id_pangkat."'>
