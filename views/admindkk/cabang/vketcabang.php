<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function(){
            ...
            var url = "<?php echo site_url('admindkk/formketcabang');?>";
        ...
        $(".edit").click(function(){
            ...
            var url = "<?php echo site_url('admindkk/formketcabang');?>/"+id;
        ...
        $(".ya").click(function(){
            var id= $(".bg-gray").attr("href");
            window.location="<?php echo site_url('admindkk/hapusketcabang');?>/"+id;
            return false;
        });
                ...
                <table class="table table-bordered table-hover" id="myTable">
                    ...
                    <thead>
                        ...
                        <tr class="bg-navy">
                            ...
                            <th class="text-center">Ket Cabang</th>
                    ...
                    <tbody>
                        ...
                        <?php  
                            ...
                            foreach ($q->result() as $data) {
                                ...
                                echo "<tr id=data href='".$data->id_ketcabang."'>
