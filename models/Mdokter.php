...
class Mdokter extends CI_Model
{
    ...
    function simpanjadwaldokter($aksi)
    {
        ...
        $l_senin = $this->input->post('l_senin');
        $l_selasa = $this->input->post('l_selasa');
        $l_rabu = $this->input->post('l_rabu');
        $l_kamis = $this->input->post('l_kamis');
        $l_jumat = $this->input->post('l_jumat');
        $l_sabtu = $this->input->post('l_sabtu');
        $l_minggu = $this->input->post('l_minggu');

        $b_senin = $this->input->post('b_senin');
        $b_selasa = $this->input->post('b_selasa');
        $b_rabu = $this->input->post('b_rabu');
        $b_kamis = $this->input->post('b_kamis');
        $b_jumat = $this->input->post('b_jumat');
        $b_sabtu = $this->input->post('b_sabtu');
        $b_minggu = $this->input->post('b_minggu');
        ...
        switch ($aksi) {
            case 'simpan':
                $data = array(
                    ...
                    "lama" => $l_minggu . ',' . $l_senin . ',' . $l_selasa . ',' . $l_rabu . ',' . $l_kamis . ',' . $l_jumat . ',' . $l_sabtu,
                    "baru" => $b_minggu . ',' . $b_senin . ',' . $b_sebasa . ',' . $b_rabu . ',' . $b_kamis . ',' . $b_jumat . ',' . $b_sabtu
                );
    ...
    function simpanigd($no_reg, $asal = "assesmen")
    {
        ...
        if ($asal == "assesmen") {
            if ($tindakan_radiologi1 != "")
                $this->simpankonsulrad($this->input->post("no_rm"), $this->input->post("no_reg"), $this->input->post("tanggal_masuk"), $this->input->post("jam_masuk"));
            else {
                $q = $this->db->get_where("pasien_ralan", ["no_reg_sebelumnya" => $no_reg, "tujuan_poli" => "0102025"]);
                if ($q->num_rows() > 0) {
                    $row = $q->row();
                    $e = $this->db->get_where("ekspertisi", ["no_reg" => $row->no_reg]);
                    if ($e->num_rows() <= 0) {
                        $this->db->where("depo", "igd");
            ...
            if ($tindakan_lab1 != "")
                $this->simpankonsullab($this->input->post("no_rm"), $this->input->post("no_reg"), $this->input->post("tanggal_masuk"), $this->input->post("jam_masuk"));
            else {
                $q = $this->db->get_where("pasien_ralan", ["no_reg_sebelumnya" => $no_reg, "tujuan_poli" => "0102024"]);
                if ($q->num_rows() > 0) {
                    $row = $q->row();
                    $e = $this->db->get_where("ekspertisi_lab", ["no_reg" => $row->no_reg]);
                    if ($e->num_rows() <= 0) {
                        $this->db->where("no_reg", $no_reg);
                        $this->db->update("pasien_igd", $data);
                        $this->db->where("depo", "igd");
    ...
    function getassesmen_perawat($no_reg, $shift = "igd")
    {
        ...
        $q = $this->db->get_where("assesmen_perawat a", ["a.no_reg" => $no_reg, "a.shift" => $shift]);
        return $q;
    }
    ...
    function simpanhd()
    {
      ...
      $this->db->where("no_pasien", $this->input->post("no_pasien"));
        ...
        if ($q->num_rows() > 0) {
            $data = array(
              'instruksi_medik' => $this->input->post("instruksi_medik1") . "," . $this->input->post("instruksi_medik2") . "," . $this->input->post("instruksi_medik3") . "," . $this->input->post("instruksi_medik4") . "," . $this->input->post("instruksi_medik5") . "," . $this->input->post("instruksi_medik6") . "," . $this->input->post("instruksi_medik7") . "," . $this->input->post("instruksi_medik8") . "," . $this->input->post("instruksi_medik9") . "," . $this->input->post("instruksi_medik10") . "," . $this->input->post("instruksi_medik11") . "," . $this->input->post("instruksi_medik12") . "," . $this->input->post("instruksi_medik13") . "," . $this->input->post("instruksi_medik14") . "," . $this->input->post("instruksi_medik15") . "," . $this->input->post("instruksi_medik16") . "," . $this->input->post("instruksi_medik17"),
              "heparinisasi1"          => $this->input->post("heparinisasi1"),
              "heparinisasi2"          => $this->input->post("heparinisasi2"),
              "heparinisasi3"          => $this->input->post("heparinisasi3"),
              "heparinisasi4"          => $this->input->post("heparinisasi4"),
              "heparinisasi5"          => $this->input->post("heparinisasi5"),
              "heparinisasi6"          => $this->input->post("heparinisasi6"),
              "diagnosa_kerja"         => $this->input->post("diagnosa_kerja"),
              'pengobatan_tindakan'    => $this->input->post("pengobatan_tindakan1") . "," . $this->input->post("pengobatan_tindakan2") . "," . $this->input->post("pengobatan_tindakan3") . "," . $this->input->post("pengobatan_tindakan4") . "," . $this->input->post("pengobatan_tindakan5") . "," . $this->input->post("pengobatan_tindakan6") . "," . $this->input->post("pengobatan_tindakan7") . "," . $this->input->post("pengobatan_tindakan8") . "," . $this->input->post("pengobatan_tindakan9"),
              'dischart_planning'      => $this->input->post("dischart_planning1") . "," . $this->input->post("dischart_planning2") . "," . $this->input->post("dischart_planning3") . "," . $this->input->post("dischart_planning4") . "," . $this->input->post("dischart_planning5"),
              "akses_vaskuler"         => $this->input->post("akses_vaskuler")
            );
            $this->db->where("no_pasien", $this->input->post("no_pasien"));
            $this->db->where("no_reg", $this->input->post("no_reg"));
            $this->db->update("hd", $data);
        } else {
            $data = array(
                "no_reg"          => $this->input->post("no_reg"),
                "no_pasien"       => $this->input->post("no_pasien"),
