...
class Mpendaftaran extends CI_Model
{
    ...
    {
        $this->db->select("p.*,pus.nama_puskesmas,prov.name as nama_provinsi,r.name as nama_kota,d.name as nama_kecamatan, v.name as nama_kelurahan,per.nama as nama_perusahaan,pa.keterangan as nama_pangkat,k.keterangan as nama_kesatuan, p.nama_pasangan as nama_pasangan");
